...
Or0 f109 startCustomFields 'cssIcon=fa fa-drivers-license-o
...
Or0 f106 startCustomFields 'cssIcon=fa fa-html5
embedInFrame=false' #txt
...
Or0 f42 startCustomFields 'cssIcon=fa fa-code
embedInFrame=false' #txt
...
Or0 f39 startCustomFields 'cssIcon=fa  fa-spinner
embedInFrame=false' #txt
...
Or0 f0 startCustomFields 'cssIcon=fa fa-exclamation-triangle
embedInFrame=false' #txt
...
Or0 f5 startCustomFields 'cssIcon=fa fa-th
embedInFrame=false' #txt
