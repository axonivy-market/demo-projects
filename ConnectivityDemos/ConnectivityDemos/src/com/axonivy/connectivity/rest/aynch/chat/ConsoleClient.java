 ...
 * 
 * Immediately starts a new asynchronous listeners for the service if a message is received.
 * 
 * @since 7.3.0
 */
public class ConsoleClient implements InvocationCallback<List<ChatMessage>> 
{
	...
	/**
	 * @return instantiated REST client with plain JAX-RS API. 
	 * As we are not running an IvyEnvironment here.
	 */
	...
	private void waitForNextResponse(WebTarget target) {
