...
pt0 f0 inParamTable 'out.serverUri=com.axonivy.connectivity.soap.client.ServerUriHelper.getCurrentServer();
' #txt
...
pt0 f7 inParamTable 'out.serverUri=com.axonivy.connectivity.soap.client.ServerUriHelper.getCurrentServer();
' #txt
...
pt0 f11 inParamTable 'out.serverUri=com.axonivy.connectivity.soap.client.ServerUriHelper.getCurrentServer();
' #txt
