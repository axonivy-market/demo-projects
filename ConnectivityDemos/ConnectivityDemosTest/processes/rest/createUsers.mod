...
cs0 f0 type com.axonivy.connectivity.test.CreateUsersData #txt
...
' #txt
cs0 f0 actionDecl 'com.axonivy.connectivity.test.CreateUsersData out;
' #txt
cs0 f0 guid 1675F33D196A232B #txt
...
cs0 f1 type com.axonivy.connectivity.test.CreateUsersData #txt
cs0 f1 337 49 30 30 0 15 #rect
cs0 f1 @|EndIcon #fIcon
cs0 f3 actionDecl 'com.axonivy.connectivity.test.CreateUsersData out;
' #txt
...
cs0 f3 type com.axonivy.connectivity.test.CreateUsersData #txt
