package ch.ivyteam.ivy.workflow.ui.restricted.technical.WorkflowUIWindow;
 ...
 * @since <%=date%>
 */
public class WorkflowUIWindowPanel extends RichDialogBorderPanel 
