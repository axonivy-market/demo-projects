[Ivy]
[>Created: Thu Nov 25 14:55:13 CET 2010]
12A4698EBFC9D238 3.13.1 #module
...
Ms0 f9 318 238 20 20 13 0 #rect
Ms0 f9 @|RichDialogEndIcon #fIcon
Ms0 f7 expr out #txt
Ms0 f7 464 58 337 246 #arcP
Ms0 f7 1 464 232 #addKink
...
for (UserManagedTeams userManagedTeams: out.usersManagedTeamsList)
{
...
Ms0 f6 310 140 36 24 20 -2 #rect
Ms0 f6 @|RichDialogProcessStepIcon #fIcon
Ms0 f11 expr out #txt
Ms0 f11 328 58 328 140 #arcP
Ms0 f10 expr out #txt
Ms0 f10 328 164 328 238 #arcP
...
>Proto Ms0 .ui2RdDataAction 'out.usersManagedTeamsList=panel.usersManagingRolesTable.listData as List<ch.ivyteam.ivy.workflow.ui.data.administration.UserManagedTeams>;
' #txt
>Proto Ms0 .rdData2UIAction 'panel.usersManagingRolesTable.listData=in.usersManagedTeamsList;
' #txt
