...
' #txt
Cs0 f45 1696 254 1696 308 #arcP
Cs0 f46 expr out #txt
Cs0 f46 1696 332 876 455 #arcP
Cs0 f46 1 1696 440 #addKink
Cs0 f46 1 0.4241208457839823 0 0 #arcLabel
Cs0 f47 expr in #txt
Cs0 f47 1710 240 877 456 #arcP
Cs0 f47 1 1808 240 #addKink
Cs0 f47 2 1808 456 #addKink
Cs0 f47 2 0.38841056492840004 0 0 #arcLabel
Cs0 f25 expr out #txt
Cs0 f25 864 130 864 268 #arcP
...
Cs0 f23 1296 138 1122 360 #arcP
Cs0 f23 1 1296 360 #addKink
Cs0 f23 0 0.9865600422072262 0 0 #arcLabel
Cs0 f48 expr out #txt
Cs0 f48 1104 372 882 408 #arcP
Cs0 f48 1 1104 408 #addKink
...
Cs0 f51 expr in #txt
Cs0 f51 1430 176 1536 236 #arcP
Cs0 f51 1 1536 176 #addKink
...
Cs0 f53 1104 138 1104 162 #arcP
Cs0 f29 expr in #txt
...
' #txt
Cs0 f29 1104 190 1104 228 #arcP
Cs0 f54 expr in #txt
Cs0 f54 1118 176 1216 236 #arcP
Cs0 f54 1 1216 176 #addKink
...
Cs0 f2 expr out #txt
Cs0 f2 136 138 136 170 #arcP
Cs0 f16 expr out #txt
Cs0 f16 48 130 48 347 #arcP
Cs0 f5 expr out #txt
...
Cs0 f60 712 130 712 164 #arcP
Cs0 f61 type ch.ivyteam.ivy.workflow.ui.task.TaskNoteDisplayList.TaskNoteDisplayListData #txt
Cs0 f61 310 350 20 20 13 0 #rect
Cs0 f61 @|RichDialogProcessEndIcon #fIcon
Cs0 f62 expr in #txt
Cs0 f62 320 262 320 350 #arcP
Cs0 f62 0 0.1717892309927115 0 0 #arcLabel
Cs0 f10 expr out #txt
Cs0 f10 536 138 330 360 #arcP
Cs0 f10 1 536 360 #addKink
Cs0 f10 1 0.23579633607064182 0 0 #arcLabel
Cs0 f49 type ch.ivyteam.ivy.workflow.ui.task.TaskNoteDisplayList.TaskNoteDisplayListData #txt
Cs0 f49 702 350 20 20 13 0 #rect
Cs0 f49 @|RichDialogProcessEndIcon #fIcon
Cs0 f63 expr out #txt
Cs0 f63 712 188 712 350 #arcP
Cs0 f63 0 0.4278705357231431 0 0 #arcLabel
...
<elementInfo>
    ...
    <swimlaneSize>263</swimlaneSize>
    <swimlaneSize>378</swimlaneSize>
    <swimlaneSize>1265</swimlaneSize>
...
>Proto Cs0 .rdData2UIAction 'panel.addNoteButton.enabled=in.#task is initialized && 
((in.task.getState().compareTo(ch.ivyteam.ivy.workflow.TaskState.DONE)!=0) &&
(in.task.getState().compareTo(ch.ivyteam.ivy.workflow.TaskState.READY_FOR_JOIN)!=0));
...
(in.task.getState().compareTo(ch.ivyteam.ivy.workflow.TaskState.DONE)!=0 && 
	in.task.getState().compareTo(ch.ivyteam.ivy.workflow.TaskState.READY_FOR_JOIN)!=0);
panel.footerLabel.text=(in.#taskNotes == null? 
	"": 
...
Cs0 f11 out f62 tail #connect
Cs0 f62 head f61 mainIn #connect
Cs0 f8 mainOut f10 tail #connect
Cs0 f10 head f61 mainIn #connect
Cs0 f20 mainOut f63 tail #connect
Cs0 f63 head f49 mainIn #connect
