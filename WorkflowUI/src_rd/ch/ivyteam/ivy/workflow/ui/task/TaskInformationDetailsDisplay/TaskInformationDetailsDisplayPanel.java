...
private RLabel getTaskKindNameLabel() {
	if (taskKindNameLabel == null) {
		...
		taskKindNameLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/workflow/ui/task/plainStrings/taskKindName\")%> <%=ivy.cms.co(\"/ch/ivyteam/ivy/workflow/ui/common/plainStrings/name\")%>");
	}
...
private RLabel getTaskIdIconLabel() {
	if (taskIdIconLabel == null) {
		...
		taskIdIconLabel.setIconUri("<%=ivy.cms.cr(\"/ch/ivyteam/ivy/workflow/ui/task/images/taskId16\")%>");
...
private RLabel getTaskKindCodeLabel() {
	if (taskKindCodeLabel == null) {
		...
		taskKindCodeLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/workflow/ui/task/plainStrings/taskKindName\")%> <%=ivy.cms.co(\"/ch/ivyteam/ivy/workflow/ui/common/plainStrings/code\")%>");
...
private RLabel getTaskKindLabel() {
	if (taskKindLabel == null) {
		...
		taskKindLabel.setToolTipText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/workflow/ui/task/plainStrings/taskKindName\")%>");
		taskKindLabel.setIconUri("<%=ivy.cms.cr(\"/ch/ivyteam/ivy/workflow/ui/task/images/KIND_CODE16\")%>");
	}
...
private RLabel getBusinessMilestoneLabel() {
	if (businessMilestoneLabel == null) {
		...
		businessMilestoneLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/workflow/ui/task/plainStrings/taskMilestone\")%>\n");
...
private RLabel getTaskStartTimestampLabel() {
	if (taskStartTimestampLabel == null) {
		...
		taskStartTimestampLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/workflow/ui/task/plainStrings/taskStartTimestamp\")%>");
...
private RLabel getTaskStateLabel() {
	if (taskStateLabel == null) {
		...
		taskStateLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/workflow/ui/task/plainStrings/taskState\")%>");
...
private RLabel getTaskIdLabel() {
	if (taskIdLabel == null) {
		...
		taskIdLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/workflow/ui/task/plainStrings/taskId\")%>");
	}
	return taskIdLabel;
}
