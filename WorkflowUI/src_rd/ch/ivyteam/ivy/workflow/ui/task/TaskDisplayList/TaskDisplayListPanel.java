...
private RTableWithExcelExport getTasksTable() {
	if (tasksTable == null) {
		...
		tasksTable.setModelConfiguration("{/showTableheader true /autoTableheader false /showtooltip true /showIcons true /version \"3.0\"/emptyTableText \"\"/columns {{/result \"result=ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/task/taskPriority/plainStrings/\\\" + entry.getPriority().intValue())\"/version \"3.0\"/tooltip \"result=ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/task/taskPriority/plainStrings/\\\" + entry.getPriority().intValue())\"/icon \"result=\\\"/ch/ivyteam/ivy/workflow/ui/common/workflowPriorities/images/\\\" + entry.getPriority().intValue() + \\\"_16\\\"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/task/plainStrings/taskPriorityShort\\\")\"/field \"entry.getPriority()\"/condition \"\"/columnWidth \"100\"/columnStyle \"\"}{/result \"result=ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/task/taskState/plainStrings/\\\" + entry.getState())\"/version \"3.0\"/tooltip \"result=ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/task/taskState/plainStrings/\\\" + entry.getState())\"/icon \"result=\\\"/ch/ivyteam/ivy/workflow/ui/task/taskState/images/\\\" + entry.getState() + \\\"16\\\"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/common/plainStrings/stateShort\\\")\"/field \"entry.getState()\"/condition \"\"/columnWidth \"130\"/columnStyle \"\"}{/result \"result=entry.getName()\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/task/plainStrings/task\\\")\"/field \"entry.getName()\"/columnWidth \"250\"/columnStyle \"wfTask\"/cellWidget \"\"}{/result \"result=entry.getCase().getName()\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/plainStrings/case\\\")\"/field \"entry.getCase().getName()\"/condition \"\"/columnWidth \"350\"/columnStyle \"\"}{/result \"result=entry.getCase().getBusinessPriority() is initialized? \\r\\nivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/caseRisk/plainStrings/\\\" + Enum.valueOf(ch.ivyteam.ivy.workflow.WorkflowPriority.class,entry.getCase().getBusinessPriority()).ordinal() ): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"result=entry.getCase().getBusinessPriority() is initialized? \\r\\n\\t\\t\\\"/ch/ivyteam/ivy/workflow/ui/common/workflowPriorities/images/\\\" + Enum.valueOf(ch.ivyteam.ivy.workflow.WorkflowPriority.class, entry.getCase().getBusinessPriority()).ordinal() + \\\"_16\\\"\\r\\n\\t\\t: \\\"\\\"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/otherBusinessData/plainStrings/businessPriorityShort\\\")\"/field \"entry.getCase().getBusinessPriority()\"/editable \"\"/condition \"\"/columnWidth \"100\"/columnStyle \"\"/cellWidget \"\"}{/result \"result=entry.getCase().getBusinessMainContactType() is initialized? entry.getCase().getBusinessMainContactType(): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/businessMainContact/plainStrings/typeLong\\\")\"/field \"entry.getCase().getBusinessMainContactType()\"/editable \"\"/condition \"\"/columnWidth \"80\"/columnStyle \"\"/cellWidget \"\"}{/result \"result=entry.getCase().getBusinessMainContactId() is initialized? entry.getCase().getBusinessMainContactId(): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/businessMainContact/plainStrings/idLong\\\")\"/field \"entry.getCase().getBusinessMainContactId()\"/editable \"\"/condition \"\"/columnWidth \"80\"/columnStyle \"\"/cellWidget \"\"}{/result \"result=entry.getCase().getBusinessMainContactName() is initialized? entry.getCase().getBusinessMainContactName(): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/businessMainContact/plainStrings/nameLong\\\")\"/field \"entry.getCase().getBusinessMainContactName()\"/editable \"\"/condition \"\"/columnWidth \"250\"/columnStyle \"\"/cellWidget \"\"}{/result \"result=entry.getCase().getBusinessObjectCode() is initialized? entry.getCase().getBusinessObjectCode(): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/businessObject/plainStrings/codeShort\\\")\"/field \"entry.getCase().getBusinessObjectCode()\"/editable \"\"/condition \"\"/columnWidth \"80\"/columnStyle \"\"/cellWidget \"\"}{/result \"result=entry.getCase().getBusinessObjectName() is initialized? entry.getCase().getBusinessObjectName(): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/businessObject/plainStrings/nameShort\\\")\"/field \"entry.getCase().getBusinessObjectName()\"/editable \"\"/condition \"\"/columnWidth \"200\"/columnStyle \"\"/cellWidget \"\"}{/result \"result=entry.getStartTimestamp().format(ivy.var.xivy_workflow_ui_restricted_dateTimeFormatPattern)\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/common/plainStrings/startDate\\\")\"/field \"entry.getStartTimestamp()\"/columnWidth \"100\"/columnStyle \"date\"}{/result \"result=entry.getBusinessMilestoneTimestamp() is initialized? entry.getBusinessMilestoneTimestamp().format(ivy.var.xivy_workflow_ui_restricted_dateFormatPattern): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/common/plainStrings/businessMilestoneTimestampShort\\\")\"/field \"entry.getBusinessMilestoneTimestamp()\"/editable \"\"/condition \"\"/columnWidth \"80\"/columnStyle \"date\"/cellWidget \"\"}{/result \"result=entry.getExpiryTimestamp() is initialized? entry.getExpiryTimestamp().format(ivy.var.xivy_workflow_ui_restricted_dateTimeFormatPattern): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/task/plainStrings/taskExpiryTimestamp\\\")\"/field \"entry.getExpiryTimestamp()\"/condition \"\"/columnWidth \"80\"/columnStyle \"date\"}{/result \"result=entry.getDelayTimestamp() is initialized? entry.delayTimestamp.format(ivy.var.xivy_addons_restricted_dateTimeFormatPattern): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/task/plainStrings/setTaskBlockingDelayTimestampShortDesc\\\")\"/field \"entry.getDelayTimestamp()\"/editable \"\"/condition \"in.runningTaskMode && in.taskDisplayMode == 2\"/columnWidth \"100\"/cellWidget \"\"}{/result \"result=entry.getActivatorName()\"/version \"3.0\"/tooltip \"\"/icon \"result=(entry.getActivator() is initialized?\\r\\n\\t(entry.#activator.isUser() is initialized? (entry.activator.isUser()? \\\"/ch/ivyteam/ivy/workflow/ui/security/images/user16\\\": \\\"/ch/ivyteam/ivy/workflow/ui/security/images/role16\\\"): \\\"\\\"):\\r\\n\\t\\\"\\\")\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/task/plainStrings/taskActivator\\\")\"/field \"entry.getActivatorName()\"/columnWidth \"100\"/columnStyle \"\"}{/result \"result=entry.getKindName()\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/enduser/parameters/taskStageShortDesc\\\")\"/field \"entry.getKindName()\"/columnWidth \"80\"/columnStyle \"\"}{/result \"result=entry.getCase().getBusinessStartTimestamp() is initialized? entry.getCase().getBusinessStartTimestamp().format(ivy.var.xivy_workflow_ui_restricted_dateTimeFormatPattern): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/otherBusinessData/plainStrings/businessStartDateTimeLong\\\")\"/field \"entry.getCase().getBusinessStartTimestamp()\"/editable \"\"/condition \"\"/columnWidth \"100\"/columnStyle \"date\"/cellWidget \"\"}{/result \"result=entry.getCase().getBusinessMilestoneTimestamp() is initialized? entry.getCase().getBusinessMilestoneTimestamp().format(ivy.var.xivy_workflow_ui_restricted_dateFormatPattern): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/otherBusinessData/plainStrings/businessMilestoneDateTimeShort\\\")\"/field \"entry.getCase().getBusinessMilestoneTimestamp()\"/editable \"\"/condition \"\"/columnWidth \"80\"/columnStyle \"date\"/cellWidget \"\"}{/result \"result=entry.getCase().getBusinessCreatorUser() is initialized? entry.getCase().getBusinessCreatorUser(): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/otherBusinessData/plainStrings/businessCreatorUserShort\\\")\"/field \"entry.getCase().getBusinessCreatorUser()\"/editable \"\"/condition \"\"/columnWidth \"100\"/columnStyle \"\"/cellWidget \"\"}{/result \"result=entry.getWorkerUserName()\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/task/plainStrings/workerUserName\\\")\"/field \"entry.getWorkerUserName()\"/editable \"\"/condition \"!in.runningTaskMode\"/columnWidth \"100\"/columnStyle \"\"/cellWidget \"\"}{/result \"result=entry.getIdentifier()\"/version \"3.0\"/tooltip \"\"/icon \"result=\\\"/ch/ivyteam/ivy/workflow/ui/task/images/taskId16\\\"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/task/plainStrings/taskId\\\")\"/field \"entry.getIdentifier()\"/condition \"\"/columnWidth \"50\"/columnStyle \"\"}{/result \"result=entry.getCase().getIdentifier()\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/plainStrings/caseId\\\")\"/field \"entry.getCase().getIdentifier()\"/editable \"\"/condition \"\"/columnWidth \"100\"/columnStyle \"\"/cellWidget \"\"}}}");
	}
	return tasksTable;
}
