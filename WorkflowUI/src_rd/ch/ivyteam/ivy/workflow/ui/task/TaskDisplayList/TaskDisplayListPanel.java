...
private RToolBar getFindTaskToolBar() {
	if (findTaskToolBar == null) {
		...
		findTaskToolBar.setStyleProperties("{/fill \"HORIZONTAL\"/weightX \"1\"}");
