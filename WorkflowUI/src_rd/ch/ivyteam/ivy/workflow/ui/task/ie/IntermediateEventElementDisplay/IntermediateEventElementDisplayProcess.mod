[Ivy]
[>Created: Wed May 21 17:51:58 CEST 2008]
11A0B8C8AB7EFE49 3.10 #module
...
panel.processModelVersionTextArea.text=(in.#intermediateEventElement is initialized && in.#intermediateEventElement.getProcessModelVersion() is initialized? 
in.intermediateEventElement.getProcessModelVersion().getProcessModel().getName() + " / " + in.intermediateEventElement.getProcessModelVersion().getName(): "n/a");
' #txt
