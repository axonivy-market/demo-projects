[Ivy]
[>Created: Tue Sep 07 12:23:24 CEST 2010]
11A0B883DD63BC83 3.12 #module
...
' #txt
Is0 f0 embeddedRdInitializations '{/intermediateEventElementDisplayRDC {/fieldName "intermediateEventElementDisplayRDC"/startMethod "start()"/parameterMapping ""/initScript ""}/separatorRDC {/fieldName "separatorRDC"/startMethod "start(String)"/parameterMapping ""/initScript "param.separatorText = ivy.cms.co(\"/ch/ivyteam/ivy/workflow/ui/task/intermediateEvent/plainStrings/intermediateEventElement\");"}}' #txt
...
Is0 f9 expr out #txt
Is0 f9 352 148 292 317 #arcP
Is0 f9 1 352 304 #addKink
