[Ivy]
[>Created: Tue May 05 15:53:25 CEST 2009]
11A10DBA1E85BFC3 3.11 #module
...
Cs0 f3 type ch.ivyteam.ivy.workflow.ui.task.TaskFiltersSelect.TaskFiltersSelectData #txt
Cs0 f3 actionDecl 'ch.ivyteam.ivy.workflow.ui.task.TaskFiltersSelect.TaskFiltersSelectData out;
' #txt
...
' #txt
Cs0 f3 662 46 20 20 13 0 #rect
Cs0 f3 @|RichDialogProcessStartIcon #fIcon
Cs0 f4 guid 11A111AE9FF3496B #txt
Cs0 f4 type ch.ivyteam.ivy.workflow.ui.task.TaskFiltersSelect.TaskFiltersSelectData #txt
Cs0 f4 actionDecl 'ch.ivyteam.ivy.workflow.ui.task.TaskFiltersSelect.TaskFiltersSelectData out;
' #txt
...
' #txt
Cs0 f4 734 78 20 20 13 0 #rect
Cs0 f4 @|RichDialogProcessStartIcon #fIcon
Cs0 f5 type ch.ivyteam.ivy.workflow.ui.task.TaskFiltersSelect.TaskFiltersSelectData #txt
Cs0 f5 659 355 26 26 14 0 #rect
Cs0 f5 @|RichDialogProcessEndIcon #fIcon
Cs0 f6 expr out #txt
Cs0 f6 672 66 672 355 #arcP
Cs0 f7 expr out #txt
Cs0 f7 744 98 685 368 #arcP
Cs0 f7 1 744 368 #addKink
...
// task stage
out.taskStageRelationalOperatorsList = [RelationalOperator.EQUAL_IGNORE_CASE, RelationalOperator.LIKE];' #txt
...
Cs0 f24 expr in #txt
Cs0 f24 outCond '!(panel.caseProcessCategoriesComboBox.selectedListEntry as ch.ivyteam.ivy.workflow.ui.data.task.TaskHierarchyTreeNodeValue).categoryName.equals("ALL")' #txt
...
Cs0 f77 expr in #txt
Cs0 f77 outCond '!(panel.caseProcessesComboBox.selectedListEntry as ch.ivyteam.ivy.workflow.ui.data.task.TaskHierarchyTreeNodeValue).categoryName.equals("ALL")' #txt
...
Cs0 f70 expr in #txt
Cs0 f70 outCond '!(panel.caseTypesComboBox.selectedListEntry as ch.ivyteam.ivy.workflow.ui.data.task.TaskHierarchyTreeNodeValue).categoryName.equals("ALL")' #txt
...
panel.taskStageRelationalOperatorsComboBox.setSelectedIndex(0);' #txt
...
// business start time from
out.taskAvailableFilters.businessStartTimestampFromFilterIsDefined = false;
out.taskAvailableFilters.businessStartTimestampToFilterIsDefined = false;	


if (panel.businessStartTimestampFromCheckBox.isSelected() && !panel.businessStartTimestampToCheckBox.isSelected())
{
	out.taskAvailableFilters.businessStartTimestampFromFilter.property = TaskProperty.BUSINESS_START_TIMESTAMP;
	out.taskAvailableFilters.businessStartTimestampFromFilter.relationalOperator = RelationalOperator.EQUAL_OR_LARGER;
	out.taskAvailableFilters.businessStartTimestampFromFilter.value = new Date(panel.businessStartTimestampFromDatePicker.getDate()).toString();
	
	
	out.taskAvailableFilters.propertyFilter = (out.#taskAvailableFilters.#propertyFilter is initialized? 
		out.taskAvailableFilters.propertyFilter.and(out.taskAvailableFilters.businessStartTimestampFromFilter.property, 
																												out.taskAvailableFilters.businessStartTimestampFromFilter.relationalOperator, 
																												out.taskAvailableFilters.businessStartTimestampFromFilter.value):
		ivy.wf.createTaskPropertyFilter(out.taskAvailableFilters.businessStartTimestampFromFilter.property, 
																		out.taskAvailableFilters.businessStartTimestampFromFilter.relationalOperator, 
																		out.taskAvailableFilters.businessStartTimestampFromFilter.value));
	
	out.taskAvailableFilters.businessStartTimestampFromFilterIsDefined = true;
}
else
{
	...
	if (panel.businessStartTimestampFromCheckBox.isSelected() && panel.businessStartTimestampToCheckBox.isSelected())
	{
		...
		out.taskAvailableFilters.businessStartTimestampToFilter.property = TaskProperty.BUSINESS_START_TIMESTAMP;
		out.taskAvailableFilters.businessStartTimestampToFilter.relationalOperator = RelationalOperator.EQUAL_OR_SMALLER;
		out.taskAvailableFilters.businessStartTimestampToFilter.value = new Date(panel.businessStartTimestampToDatePicker.getDate()).toString();
		
		
		IPropertyFilter propertyFilterFromTo = 
						ivy.wf.createTaskPropertyFilter(out.taskAvailableFilters.businessStartTimestampFromFilter.property, 
																						out.taskAvailableFilters.businessStartTimestampFromFilter.relationalOperator, 
																						out.taskAvailableFilters.businessStartTimestampFromFilter.value).and(
																									out.taskAvailableFilters.businessStartTimestampToFilter.property, 
																									out.taskAvailableFilters.businessStartTimestampToFilter.relationalOperator, 
																									out.taskAvailableFilters.businessStartTimestampToFilter.value);
																						
		out.taskAvailableFilters.propertyFilter = (out.#taskAvailableFilters.#propertyFilter is initialized? 
			out.taskAvailableFilters.propertyFilter.and(propertyFilterFromTo):propertyFilterFromTo);
		
		out.taskAvailableFilters.businessStartTimestampFromFilterIsDefined = true;
		out.taskAvailableFilters.businessStartTimestampToFilterIsDefined = true;
	}
}
...
// task stage
if (panel.taskStageTextField.getText().length() > 0)
{
	out.taskAvailableFilters.taskStageFilter.property = TaskProperty.KIND_CODE;
	out.taskAvailableFilters.taskStageFilter.relationalOperator = panel.taskStageRelationalOperatorsComboBox.getSelectedListEntry() as RelationalOperator;
	out.taskAvailableFilters.taskStageFilter.value = (out.taskAvailableFilters.taskStageFilter.relationalOperator.compareTo(RelationalOperator.LIKE) == 0)?
																														"%" + panel.taskStageTextField.text + "%":
																														panel.taskStageTextField.text;
	
	out.taskAvailableFilters.propertyFilter = (out.#taskAvailableFilters.#propertyFilter is initialized? 
			out.taskAvailableFilters.propertyFilter.and(out.taskAvailableFilters.taskStageFilter.property, out.taskAvailableFilters.taskStageFilter.relationalOperator, out.taskAvailableFilters.taskStageFilter.value):
			ivy.wf.createTaskPropertyFilter(out.taskAvailableFilters.taskStageFilter.property, out.taskAvailableFilters.taskStageFilter.relationalOperator, out.taskAvailableFilters.taskStageFilter.value));
	
	out.taskAvailableFilters.taskStageFilterIsDefined = true;
}
else
{
	out.taskAvailableFilters.taskStageFilterIsDefined = false;
}' #txt
...
(panel.taskFiltersBoxPane.getBorder() as ULCTitledBorder).setTitle(ivy.cms.co("/ch/ivyteam/ivy/workflow/ui/task/plainStrings/taskFilters"));' #txt
...
panel.taskStageRelationalOperatorsComboBox.listData=in.taskStageRelationalOperatorsList;
' #txt
