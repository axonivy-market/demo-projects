...
private RGridBagLayoutPane getUserMenuGridBagLayoutPane() {
	if (userMenuGridBagLayoutPane == null) {
		...
		userMenuGridBagLayoutPane.add(getSettingsHyperlink(), new com.ulcjava.base.application.GridBagConstraints(1, 19, 1, 1, -1, -1, com.ulcjava.base.application.GridBagConstraints.CENTER, com.ulcjava.base.application.GridBagConstraints.NONE, new com.ulcjava.base.application.util.Insets(0,0,0,0), 0, 0));
		...
		userMenuGridBagLayoutPane.add(getAbsenceHyperlink(), new com.ulcjava.base.application.GridBagConstraints(1, 22, 1, 1, -1, -1, com.ulcjava.base.application.GridBagConstraints.CENTER, com.ulcjava.base.application.GridBagConstraints.NONE, new com.ulcjava.base.application.util.Insets(0,0,0,0), 0, 0));
		userMenuGridBagLayoutPane.add(getUserSecurityHyperlink(), new com.ulcjava.base.application.GridBagConstraints(1, 29, 1, 1, -1, -1, com.ulcjava.base.application.GridBagConstraints.CENTER, com.ulcjava.base.application.GridBagConstraints.NONE, new com.ulcjava.base.application.util.Insets(0,0,0,0), 0, 0));
		userMenuGridBagLayoutPane.add(getRoleSecurityHyperlink(), new com.ulcjava.base.application.GridBagConstraints(1, 30, 1, 1, -1, -1, com.ulcjava.base.application.GridBagConstraints.CENTER, com.ulcjava.base.application.GridBagConstraints.NONE, new com.ulcjava.base.application.util.Insets(0,0,0,0), 0, 0));
		userMenuGridBagLayoutPane.add(getCleanHyperlink(), new com.ulcjava.base.application.GridBagConstraints(1, 23, 1, 1, -1, -1, com.ulcjava.base.application.GridBagConstraints.CENTER, com.ulcjava.base.application.GridBagConstraints.NONE, new com.ulcjava.base.application.util.Insets(0,0,0,0), 0, 0));
		userMenuGridBagLayoutPane.add(getCalendarHyperlink(), new com.ulcjava.base.application.GridBagConstraints(1, 21, 1, 1, -1, -1, com.ulcjava.base.application.GridBagConstraints.CENTER, com.ulcjava.base.application.GridBagConstraints.NONE, new com.ulcjava.base.application.util.Insets(0,0,0,0), 0, 0));
		userMenuGridBagLayoutPane.add(userMenuFiller111, new com.ulcjava.base.application.GridBagConstraints(0, 25, 1, 1, -1, -1, com.ulcjava.base.application.GridBagConstraints.CENTER, com.ulcjava.base.application.GridBagConstraints.NONE, new com.ulcjava.base.application.util.Insets(0,0,0,0), 0, 0));
		...
		userMenuGridBagLayoutPane.add(getSecurityLabel(), new com.ulcjava.base.application.GridBagConstraints(0, 27, 2, 1, -1, -1, com.ulcjava.base.application.GridBagConstraints.CENTER, com.ulcjava.base.application.GridBagConstraints.NONE, new com.ulcjava.base.application.util.Insets(0,0,0,0), 0, 0));
...
private RCardPane getUserMenuElementsCardPane() {
	if (userMenuElementsCardPane == null) {
		...
		userMenuElementsCardPane.setPreferredSize(new com.ulcjava.base.application.util.Dimension(200,200));
