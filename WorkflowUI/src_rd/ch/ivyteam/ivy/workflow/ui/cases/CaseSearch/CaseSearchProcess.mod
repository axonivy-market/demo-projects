[Ivy]
[>Created: Thu May 14 16:47:48 CEST 2009]
11A9B75F7E57BD13 3.11 #module
...
Cs0 @RichDialogProcessEnd f169 '' #zField
...
Cs0 @RichDialogProcessStep f76 '' #zField
...
' #txt
Cs0 f6 754 314 28 28 14 0 #rect
Cs0 f6 @|AlternativeIcon #fIcon
Cs0 f8 actionDecl 'ch.ivyteam.ivy.workflow.ui.cases.CaseSearch.CaseSearchData out;
' #txt
Cs0 f8 actionTable 'out=in;
' #txt
Cs0 f8 type ch.ivyteam.ivy.workflow.ui.cases.CaseSearch.CaseSearchData #txt
Cs0 f8 750 524 36 24 20 -2 #rect
Cs0 f8 @|RichDialogProcessStepIcon #fIcon
Cs0 f5 expr out #txt
Cs0 f5 768 548 768 579 #arcP
...
' #txt
Cs0 f10 actionCode '// Case process caseProcessCategory name/Case process name/Case type name/Case sub type name
...
{
	caseProcessCategoriesIGroup.addAll(ivy.session.findInvolvedCasesCategories(filter, ch.ivyteam.ivy.workflow.CaseProperty.PROCESS_CATEGORY_CODE, null));
}
else
{
	if (in.caseDisplayMode == 1)
	{
		caseProcessCategoriesIGroup.addAll(ivy.session.findInvolvedCasesByRoleCategories(ivy.session.getSessionUser().getRoles(), filter, ch.ivyteam.ivy.workflow.CaseProperty.PROCESS_CATEGORY_CODE, null));
	}
	else
	{
		if (in.caseDisplayMode == 2)
		{
			caseProcessCategoriesIGroup.addAll(ivy.wf.findCaseCategories(filter, ch.ivyteam.ivy.workflow.CaseProperty.PROCESS_CATEGORY_CODE, null));
		}	
	}	
}
...
for (IGroup caseProcessCategory: caseProcessCategoriesIGroup)
{
   ...
   processCategoryTreeNodeValue.categoryName = (elementOfCaseProcessCategoriesICase.getProcessName() is initialized? elementOfCaseProcessCategoriesICase.getProcessCategoryName(): 
					(elementOfCaseProcessCategoriesICase.getProcessCategoryCode() is initialized? elementOfCaseProcessCategoriesICase.getProcessCategoryCode(): out.unclassifiedCaseTitle )) + " (" + caseProcessCategory.getNumberOfObjectsInGroup() + ")";
   ...
   caseProcessesIGroup.clear();
	...
	if (in.caseDisplayMode == 0)
	{
		caseProcessesIGroup.addAll(ivy.session.findInvolvedCasesCategories(filter, ch.ivyteam.ivy.workflow.CaseProperty.PROCESS_CODE, null));
	}
	else
	{
		if (in.caseDisplayMode == 1)
		{
			caseProcessesIGroup.addAll(ivy.session.findInvolvedCasesByRoleCategories(ivy.session.getSessionUser().getRoles(), filter, ch.ivyteam.ivy.workflow.CaseProperty.PROCESS_CODE, null));
		}
		else
		{
			if (in.caseDisplayMode == 2)
			{
				caseProcessesIGroup.addAll(ivy.wf.findCaseCategories(filter, ch.ivyteam.ivy.workflow.CaseProperty.PROCESS_CODE, null));
			}	
		}	
	}
   ...
   for (IGroup caseProcess: caseProcessesIGroup)
   {
      ...
      caseProcessTreeNodeValue.categoryName = (elementOfCaseProcessesICase.getProcessName() is initialized? elementOfCaseProcessesICase.getProcessName(): caseProcessTreeNodeValue.categoryCode) + " (" + caseProcess.getNumberOfObjectsInGroup() + ")";
      ...
      filter = ivy.wf.createCasePropertyFilter(ch.ivyteam.ivy.workflow.CaseProperty.PROCESS_CATEGORY_CODE, ch.ivyteam.logicalexpression.RelationalOperator.EQUAL, elementOfCaseProcessCategoriesICase.getProcessCategoryCode()).and(
			...
			if (in.caseDisplayMode == 0)
			{
				caseTypesIGroup.addAll(ivy.session.findInvolvedCasesCategories(filter, ch.ivyteam.ivy.workflow.CaseProperty.TYPE_CODE, null));
			}
			else
			{
				if (in.caseDisplayMode == 1)
				{
					caseTypesIGroup.addAll(ivy.session.findInvolvedCasesByRoleCategories(ivy.session.getSessionUser().getRoles(), filter, ch.ivyteam.ivy.workflow.CaseProperty.TYPE_CODE, null));
				}
				else
				{
					if (in.caseDisplayMode == 2)
					{
						caseTypesIGroup.addAll(ivy.wf.findCaseCategories(filter, ch.ivyteam.ivy.workflow.CaseProperty.TYPE_CODE, null));
					}	
				}	
			}
      ...
      for (IGroup caseType: caseTypesIGroup)
      {
         ...
         caseTypeTreeNodeValue.categoryName = (elementOfCaseTypesICase.getTypeName() is initialized? elementOfCaseTypesICase.getTypeName(): caseTypeTreeNodeValue.categoryCode) + " (" + caseType.getNumberOfObjectsInGroup() + ")";
         ...
         filter = ivy.wf.createCasePropertyFilter(ch.ivyteam.ivy.workflow.CaseProperty.PROCESS_CATEGORY_CODE, ch.ivyteam.logicalexpression.RelationalOperator.EQUAL, elementOfCaseProcessCategoriesICase.getProcessCategoryCode()).and(
				...
				if (in.caseDisplayMode == 0)
				{
					caseSubTypesIGroup.addAll(ivy.session.findInvolvedCasesCategories(filter, ch.ivyteam.ivy.workflow.CaseProperty.SUB_TYPE_CODE, null));
				}
				else
				{
					if (in.caseDisplayMode == 1)
					{
						caseSubTypesIGroup.addAll(ivy.session.findInvolvedCasesByRoleCategories(ivy.session.getSessionUser().getRoles(), filter, ch.ivyteam.ivy.workflow.CaseProperty.SUB_TYPE_CODE, null));
					}
					else
					{
						if (in.caseDisplayMode == 2)
						{
							caseSubTypesIGroup.addAll(ivy.wf.findCaseCategories(filter, ch.ivyteam.ivy.workflow.CaseProperty.SUB_TYPE_CODE, null));
						}	
					}	
				}
         ...
         for (IGroup caseSubType: caseSubTypesIGroup)
         {
            ...
            caseSubTypeTreeNodeValue.categoryName = (elementOfCaseSubTypesICase.getSubTypeName() is initialized? elementOfCaseSubTypesICase.getSubTypeName(): caseSubTypeTreeNodeValue.categoryCode) + " (" + caseSubType.getNumberOfObjectsInGroup() +")";
...
' #txt
Cs0 f9 actionCode 'import ch.ivyteam.ivy.workflow.ui.data.cases.CaseHierarchyTreeNodeValue;
import ch.ivyteam.ivy.workflow.ICase;
import ch.ivyteam.ivy.workflow.IPropertyFilter;
import ch.ivyteam.ivy.persistence.IGroup;
...
Cs0 f9 358 412 36 24 20 -2 #rect
...
for (IGroup caseProcessCategory: caseProcessCategoriesIGroup)
{
   ...
   for (IGroup caseProcess: caseProcessesIGroup)
   {
      ...
      filter = ivy.wf.createCasePropertyFilter(ch.ivyteam.ivy.workflow.CaseProperty.PROCESS_CATEGORY_CODE, ch.ivyteam.logicalexpression.RelationalOperator.EQUAL, elementOfCaseProcessCategoriesICase.getProcessCategoryCode()).and(
			...
			if (in.caseDisplayMode == 0)
			{
				businessMainContactsIGroup.addAll(ivy.session.findInvolvedCasesCategories(filter, ch.ivyteam.ivy.workflow.CaseProperty.BUSINESS_MAIN_CONTACT_ID, null));
			}
			else
			{
				if (in.caseDisplayMode == 1)
				{
					businessMainContactsIGroup.addAll(ivy.session.findInvolvedCasesByRoleCategories(ivy.session.getSessionUser().getRoles(), filter, ch.ivyteam.ivy.workflow.CaseProperty.BUSINESS_MAIN_CONTACT_ID, null));
				}
				else
				{
					if (in.caseDisplayMode == 2)
					{
						businessMainContactsIGroup.addAll(ivy.wf.findCaseCategories(filter, ch.ivyteam.ivy.workflow.CaseProperty.BUSINESS_MAIN_CONTACT_ID, null));
					}	
				}	
			}
      ...
      for (IGroup businessMainContact: businessMainContactsIGroup)
      {
         ...
         businessMainContactTreeNodeValue.categoryName = (elementOfBusinessMainContactsICase.getBusinessMainContactName() is initialized? elementOfBusinessMainContactsICase.getBusinessMainContactName(): businessMainContactTreeNodeValue.categoryCode) + " (" + businessMainContact.getNumberOfObjectsInGroup() + ")";
...
Cs0 f12 550 412 36 24 20 -2 #rect
...
' #txt
Cs0 f13 actionCode 'import ch.ivyteam.ivy.workflow.ui.data.cases.CaseHierarchyTreeNodeValue;
import ch.ivyteam.ivy.workflow.ICase;
import ch.ivyteam.ivy.workflow.IPropertyFilter;
import ch.ivyteam.ivy.persistence.IGroup;
...
Cs0 f13 750 412 36 24 20 -2 #rect
...
' #txt
Cs0 f14 actionCode 'import ch.ivyteam.ivy.workflow.ui.data.cases.CaseHierarchyTreeNodeValue;
import ch.ivyteam.ivy.workflow.ICase;
import ch.ivyteam.ivy.workflow.IPropertyFilter;
import ch.ivyteam.ivy.persistence.IGroup;
...
for (IGroup caseProcessCategory: caseProcessCategoriesIGroup)
{
   ...
   businessStartTimeStampsIGroup.clear();
		...
		if (in.caseDisplayMode == 0)
		{
			businessStartTimeStampsIGroup.addAll(ivy.session.findInvolvedCasesCategories(filter, ch.ivyteam.ivy.workflow.CaseProperty.BUSINESS_START_TIMESTAMP, null));
		...
		else
		{
			if (in.caseDisplayMode == 1)
			{
				businessStartTimeStampsIGroup.addAll(ivy.session.findInvolvedCasesByRoleCategories(ivy.session.getSessionUser().getRoles(), filter, ch.ivyteam.ivy.workflow.CaseProperty.BUSINESS_START_TIMESTAMP, null));
			...
			else
			{
				if (in.caseDisplayMode == 2)
				{
					businessStartTimeStampsIGroup.addAll(ivy.wf.findCaseCategories(filter, ch.ivyteam.ivy.workflow.CaseProperty.BUSINESS_START_TIMESTAMP, null));
				}	
			}	
		}
   ...
   for (IGroup businessStartTimeStamp: businessStartTimeStampsIGroup)
   {
      ...
      businessStartTimeStampTreeNodeValue.categoryName = (elementOfBusinessStartTimeStampsICase.getBusinessStartTimestamp() is initialized? new DateTime(elementOfBusinessStartTimeStampsICase.getBusinessStartTimestamp()).format("medium"): "") + " (" + businessStartTimeStamp.getNumberOfObjectsInGroup() + ")";
...
Cs0 f14 934 412 36 24 20 -2 #rect
Cs0 f14 @|RichDialogProcessStepIcon #fIcon
Cs0 f15 expr in #txt
Cs0 f15 outCond 'in.caseHierarchyLayoutSelectedIndex == 1' #txt
Cs0 f15 755 329 376 412 #arcP
Cs0 f15 1 376 344 #addKink
Cs0 f15 0 0.7321248043353128 0 0 #arcLabel
Cs0 f16 expr out #txt
Cs0 f16 200 436 750 536 #arcP
Cs0 f16 1 200 536 #addKink
Cs0 f16 1 0.3092412166948326 0 0 #arcLabel
Cs0 f17 expr out #txt
Cs0 f17 376 436 750 535 #arcP
Cs0 f17 1 376 520 #addKink
Cs0 f17 1 0.1978495288359874 0 0 #arcLabel
Cs0 f18 expr in #txt
Cs0 f18 outCond 'in.caseHierarchyLayoutSelectedIndex == 2' #txt
Cs0 f18 756 330 568 412 #arcP
Cs0 f18 1 568 352 #addKink
Cs0 f18 0 0.6920545645180359 0 0 #arcLabel
Cs0 f19 expr out #txt
Cs0 f19 568 436 750 533 #arcP
Cs0 f19 1 568 504 #addKink
Cs0 f19 1 0.27630520271975495 0 0 #arcLabel
Cs0 f20 expr in #txt
Cs0 f20 outCond 'in.caseHierarchyLayoutSelectedIndex == 3' #txt
Cs0 f20 768 342 768 412 #arcP
Cs0 f20 0 0.32753262063191424 0 0 #arcLabel
Cs0 f21 expr out #txt
Cs0 f21 768 436 768 524 #arcP
Cs0 f21 0 0.40592719056425014 0 0 #arcLabel
Cs0 f22 expr in #txt
Cs0 f22 outCond 'in.caseHierarchyLayoutSelectedIndex == 4' #txt
Cs0 f22 780 331 952 412 #arcP
Cs0 f22 1 952 368 #addKink
Cs0 f22 0 0.6350626509682887 0 0 #arcLabel
Cs0 f23 expr out #txt
Cs0 f23 952 436 786 533 #arcP
Cs0 f23 1 952 504 #addKink
Cs0 f23 1 0.29670705027713784 0 0 #arcLabel
...
' #txt
Cs0 f24 actionCode 'import ch.ivyteam.ivy.workflow.ui.data.cases.CaseHierarchyTreeNodeValue;
import ch.ivyteam.ivy.workflow.ICase;
import ch.ivyteam.ivy.workflow.IPropertyFilter;
import ch.ivyteam.ivy.persistence.IGroup;
...
Cs0 f24 1134 412 36 24 20 -2 #rect
...
' #txt
Cs0 f25 actionCode 'import ch.ivyteam.ivy.workflow.ui.data.cases.CaseHierarchyTreeNodeValue;
import ch.ivyteam.ivy.workflow.ICase;
import ch.ivyteam.ivy.workflow.IPropertyFilter;
import ch.ivyteam.ivy.persistence.IGroup;
...
for (IGroup caseProcessCategory: caseProcessCategoriesIGroup)
{
   ...
   filter = ivy.wf.createCasePropertyFilter(ch.ivyteam.ivy.workflow.CaseProperty.PROCESS_CATEGORY_CODE, ch.ivyteam.logicalexpression.RelationalOperator.EQUAL, elementOfCaseProcessCategoriesICase.getProcessCategoryCode());
	  ...
	  businessCreatorUsersIGroup.clear();
		...
		if (in.caseDisplayMode == 0)
		{
			businessCreatorUsersIGroup.addAll(ivy.session.findInvolvedCasesCategories(filter, ch.ivyteam.ivy.workflow.CaseProperty.BUSINESS_CREATOR_USER, null));
		}
		else
		{
			if (in.caseDisplayMode == 1)
			{
				businessCreatorUsersIGroup.addAll(ivy.session.findInvolvedCasesByRoleCategories(ivy.session.getSessionUser().getRoles(), filter, ch.ivyteam.ivy.workflow.CaseProperty.BUSINESS_CREATOR_USER, null));
			}
			else
			{
				if (in.caseDisplayMode == 2)
				{
					businessCreatorUsersIGroup.addAll(ivy.wf.findCaseCategories(filter, ch.ivyteam.ivy.workflow.CaseProperty.BUSINESS_CREATOR_USER, null));
				}	
			}	
		}
...
Cs0 f25 1334 412 36 24 20 -2 #rect
Cs0 f25 @|RichDialogProcessStepIcon #fIcon
Cs0 f26 expr in #txt
Cs0 f26 outCond 'in.caseHierarchyLayoutSelectedIndex == 5' #txt
Cs0 f26 781 329 1152 412 #arcP
Cs0 f26 1 1152 352 #addKink
Cs0 f26 0 0.6231640838022615 0 0 #arcLabel
Cs0 f27 expr out #txt
Cs0 f27 1152 436 786 535 #arcP
Cs0 f27 1 1152 512 #addKink
Cs0 f27 1 0.33194152072124145 0 0 #arcLabel
Cs0 f28 expr in #txt
Cs0 f28 outCond 'in.caseHierarchyLayoutSelectedIndex == 6' #txt
Cs0 f28 782 328 1352 412 #arcP
Cs0 f28 1 1352 344 #addKink
Cs0 f28 0 0.6180625399490141 0 0 #arcLabel
Cs0 f29 expr out #txt
Cs0 f29 1352 436 786 536 #arcP
Cs0 f29 1 1352 520 #addKink
Cs0 f29 1 0.3609044357048956 0 0 #arcLabel
...
// is a Workflow Administration permission?
...
out.hasPermissionCaseRead = ivy.session.hasPermission(ivy.request.getApplication().getSecurityDescriptor(), 
																										ch.ivyteam.ivy.security.IPermission.CASE_READ);
...
Cs0 f30 86 156 36 24 20 -2 #rect
Cs0 f30 @|RichDialogProcessStepIcon #fIcon
Cs0 f2 expr out #txt
Cs0 f2 104 180 104 275 #arcP
...
' #txt
Cs0 f32 1054 54 20 20 13 0 #rect
...
' #txt
Cs0 f33 1190 54 20 20 13 0 #rect
...
' #txt
Cs0 f34 1326 54 20 20 13 0 #rect
...
' #txt
Cs0 f39 942 54 20 20 13 0 #rect
Cs0 f39 @|RichDialogProcessStartIcon #fIcon
Cs0 f40 expr out #txt
Cs0 f40 952 74 786 120 #arcP
Cs0 f40 1 952 120 #addKink
...
' #txt
Cs0 f42 754 234 28 28 14 0 #rect
...
Cs0 f44 838 268 36 24 20 -2 #rect
...
' #txt
Cs0 f45 782 248 856 268 #arcP
Cs0 f45 1 856 248 #addKink
Cs0 f45 0 0.7979555173134776 0 0 #arcLabel
Cs0 f46 expr out #txt
Cs0 f46 856 292 780 326 #arcP
Cs0 f46 1 856 312 #addKink
Cs0 f46 0 0.8687109049763829 0 0 #arcLabel
Cs0 f7 expr in #txt
Cs0 f7 768 262 768 314 #arcP
...
' #txt
Cs0 f47 754 170 28 28 14 0 #rect
Cs0 f47 @|AlternativeIcon #fIcon
Cs0 f48 expr out #txt
Cs0 f48 768 132 768 170 #arcP
Cs0 f41 expr in #txt
Cs0 f41 outCond 'in.caseHierarchyLayoutSelectedIndex < 0 || in.caseHierarchyLayoutSelectedIndex > 6' #txt
...
' #txt
Cs0 f41 782 184 786 536 #arcP
Cs0 f41 1 1528 184 #addKink
Cs0 f41 2 1528 536 #addKink
Cs0 f41 0 0.7472924187725631 0 -1 #arcLabel
Cs0 f43 expr in #txt
Cs0 f43 768 198 768 234 #arcP
...
' #txt
Cs0 f49 334 54 20 20 13 0 #rect
...
Cs0 f51 86 100 36 24 20 -2 #rect
Cs0 f51 @|RichDialogProcessStepIcon #fIcon
Cs0 f52 expr out #txt
Cs0 f52 104 74 104 100 #arcP
Cs0 f31 expr out #txt
Cs0 f31 104 124 104 156 #arcP
...
out.sortByPriority = 
	(hasUserReadPropertyPermission && ivy.session.getSessionUser().getProperty(UserPropertyKeys.CASES_SORTED_BY_PRIORITY_PROPERTY_KEY).length() > 0)?
...
out.multipleCaseListMode = 
	(hasUserReadPropertyPermission && ivy.session.getSessionUser().getProperty(UserPropertyKeys.IS_MULTIPLE_CASELIST_MODE_PROPERTY_KEY).length() > 0)?
...
' #txt
Cs0 f53 206 54 20 20 -22 -31 #rect
Cs0 f53 @|RichDialogInitStartIcon #fIcon
Cs0 f55 expr out #txt
Cs0 f55 216 74 122 168 #arcP
Cs0 f55 1 216 168 #addKink
...
' #txt
Cs0 f54 462 54 20 20 13 0 #rect
Cs0 f54 @|RichDialogMethodStartIcon #fIcon
Cs0 f56 expr out #txt
Cs0 f56 472 74 117 288 #arcP
Cs0 f56 1 472 288 #addKink
Cs0 f56 1 0.25262471631581684 0 0 #arcLabel
...
' #txt
Cs0 f60 186 690 28 28 14 0 #rect
Cs0 f60 @|AlternativeIcon #fIcon
Cs0 f61 expr out #txt
Cs0 f61 200 642 200 690 #arcP
...
' #txt
Cs0 f62 186 778 28 28 14 0 #rect
...
' #txt
Cs0 f63 200 718 200 778 #arcP
Cs0 f64 expr in #txt
Cs0 f64 214 704 213 1048 #arcP
Cs0 f64 1 544 704 #addKink
Cs0 f64 2 544 1048 #addKink
...
' #txt
Cs0 f65 actionCode 'import ch.ivyteam.ivy.workflow.ui.utils.WorkflowUIAccessPermissionHandler;
import ch.ivyteam.ivy.workflow.ui.data.cases.CaseHierarchyTreeNodeValue;
import ch.ivyteam.ivy.workflow.IPropertyFilter;
...
else
{
	...
	else
	{
		if (in.caseDisplayMode == 2)
		{
			queryResult = queryResult = ivy.wf.findCases(filter, order, startIndex, count, returnAllCount);
		}	
	}	
}
...
{
	ICase elementOfCasesICase = result.get(i);
	caseTree = new Tree(elementOfCasesICase , "ID");
...
Cs0 f65 382 868 36 24 20 -2 #rect
...
' #txt
Cs0 f66 214 792 400 868 #arcP
Cs0 f66 1 400 792 #addKink
Cs0 f66 0 0.775990530620688 0 0 #arcLabel
Cs0 f67 expr out #txt
Cs0 f67 400 892 213 1048 #arcP
Cs0 f67 1 400 1048 #addKink
...
Cs0 f69 182 892 36 24 20 -2 #rect
Cs0 f69 @|RichDialogProcessStepIcon #fIcon
Cs0 f70 expr in #txt
Cs0 f70 200 806 200 892 #arcP
Cs0 f59 expr out #txt
Cs0 f59 200 916 200 1035 #arcP
...
' #txt
Cs0 f74 714 762 28 28 14 0 #rect
...
Cs0 f79 926 852 36 24 20 -2 #rect
...
' #txt
Cs0 f80 742 824 944 852 #arcP
Cs0 f80 1 944 824 #addKink
...
' #txt
Cs0 f81 714 906 28 28 14 0 #rect
Cs0 f81 @|AlternativeIcon #fIcon
Cs0 f83 expr out #txt
Cs0 f83 944 876 742 920 #arcP
Cs0 f83 1 944 920 #addKink
...
Cs0 f84 926 948 36 24 20 -2 #rect
...
' #txt
Cs0 f85 741 921 944 948 #arcP
Cs0 f85 1 944 936 #addKink
...
Cs0 f86 targetDisplay <%=in.destinationDisplay.displayId%> #txt
...
Cs0 f86 requestMappingAction 'param.aCaseDisplayListParentDisplay=in.destinationDisplay;
...
Cs0 f96 710 852 36 24 20 -2 #rect
Cs0 f96 @|RichDialogProcessStepIcon #fIcon
Cs0 f97 expr in #txt
Cs0 f97 728 838 728 852 #arcP
Cs0 f82 expr out #txt
Cs0 f82 728 876 728 906 #arcP
...
Cs0 f88 926 1020 36 24 20 -2 #rect
Cs0 f88 @|RichDialogIcon #fIcon
Cs0 f101 expr in #txt
Cs0 f101 741 985 944 1020 #arcP
Cs0 f101 1 944 1000 #addKink
Cs0 f101 0 0.6249219481659769 0 0 #arcLabel
Cs0 f102 expr out #txt
Cs0 f102 944 1044 740 1086 #arcP
Cs0 f102 1 944 1064 #addKink
...
if (panel.caseDisplayModeFlowLayoutPane.getBorder() != null && panel.caseDisplayModeFlowLayoutPane.getBorder() instanceof ULCTitledBorder)
{
	String title = ivy.cms.co("/ch/ivyteam/ivy/workflow/ui/case/plainStrings/caseDisplayMode");
	(panel.caseDisplayModeFlowLayoutPane.getBorder() as ULCTitledBorder).setTitle(title);																				
}

(panel.viewGridBagLayoutPane.getBorder() as ULCTitledBorder).title = 								
		ivy.cms.co("/ch/ivyteam/ivy/workflow/ui/case/plainStrings/caseDisplayOptions");

(panel.filterBoxPane.getBorder() as ULCTitledBorder).title = 
		ivy.cms.co("/ch/ivyteam/ivy/workflow/ui/case/plainStrings/filterCaseList");
...
Cs0 f89 326 132 36 24 20 -2 #rect
Cs0 f89 @|RichDialogProcessStepIcon #fIcon
Cs0 f109 expr out #txt
Cs0 f109 344 74 344 132 #arcP
Cs0 f109 0 0.281762103998495 0 0 #arcLabel
Cs0 f50 expr out #txt
Cs0 f50 344 156 117 288 #arcP
Cs0 f50 1 344 288 #addKink
Cs0 f50 1 0.3476171239975997 0 0 #arcLabel
...
' #txt
Cs0 f110 714 674 28 28 14 0 #rect
Cs0 f110 @|AlternativeIcon #fIcon
Cs0 f111 expr out #txt
Cs0 f111 728 658 728 674 #arcP
Cs0 f112 expr in #txt
Cs0 f112 742 688 741 1088 #arcP
Cs0 f112 1 1448 688 #addKink
Cs0 f112 2 1448 1088 #addKink
...
' #txt
Cs0 f115 1594 722 28 28 14 0 #rect
Cs0 f115 @|AlternativeIcon #fIcon
Cs0 f116 expr out #txt
Cs0 f116 1608 674 1608 722 #arcP
...
' #txt
Cs0 f118 actionCode 'import ch.ivyteam.ivy.workflow.ICase;
...
Cs0 f118 1590 892 36 24 20 -2 #rect
Cs0 f118 @|RichDialogProcessStepIcon #fIcon
Cs0 f117 expr out #txt
Cs0 f117 1608 916 1608 1075 #arcP
...
Cs0 f120 1710 932 36 24 20 -2 #rect
Cs0 f120 @|RichDialogProcessStepIcon #fIcon
Cs0 f122 expr out #txt
Cs0 f122 1728 956 1621 1088 #arcP
Cs0 f122 1 1728 1088 #addKink
...
' #txt
Cs0 f121 1594 794 28 28 14 0 #rect
...
' #txt
Cs0 f124 1608 750 1608 794 #arcP
...
' #txt
Cs0 f119 1608 822 1608 892 #arcP
...
' #txt
Cs0 f125 1622 808 1728 932 #arcP
Cs0 f125 1 1728 808 #addKink
...
Cs0 f126 1814 988 36 24 20 -2 #rect
Cs0 f126 @|RichDialogProcessStepIcon #fIcon
Cs0 f127 expr in #txt
Cs0 f127 1622 736 1832 988 #arcP
Cs0 f127 1 1832 736 #addKink
Cs0 f127 1 0.2085490996230524 0 0 #arcLabel
Cs0 f123 expr out #txt
Cs0 f123 1832 1012 1621 1088 #arcP
Cs0 f123 1 1832 1088 #addKink
...
' #txt
Cs0 f131 2002 690 28 28 14 0 #rect
Cs0 f131 @|AlternativeIcon #fIcon
Cs0 f132 expr out #txt
Cs0 f132 2016 674 2016 690 #arcP
...
Cs0 f133 1998 796 36 24 20 -2 #rect
Cs0 f133 @|RichDialogProcessStepIcon #fIcon
Cs0 f135 expr in #txt
Cs0 f135 2030 704 2029 1088 #arcP
Cs0 f135 1 2312 704 #addKink
Cs0 f135 2 2312 1088 #addKink
...
Cs0 f136 1998 852 36 24 20 -2 #rect
Cs0 f136 @|RichDialogProcessStepIcon #fIcon
Cs0 f137 expr out #txt
Cs0 f137 2016 820 2016 852 #arcP
...
' #txt
Cs0 f138 2002 914 28 28 14 0 #rect
Cs0 f138 @|AlternativeIcon #fIcon
Cs0 f139 expr out #txt
Cs0 f139 2016 876 2016 914 #arcP
...
Cs0 f140 targetDisplay <%=in.destinationDisplay.displayId%> #txt
...
Cs0 f140 panelName '<%=in.selectedCase.getName()%> - Case id <%=in.selectedCase.getIdentifier()%>' #txt
...
' #txt
Cs0 f140 windowConfiguration '#Sun Jul 20 16:09:38 CEST 2008
use_default=true
' #txt
Cs0 f140 isAsynch true #txt
Cs0 f140 isInnerRd true #txt
Cs0 f140 isDialog false #txt
Cs0 f140 1998 980 36 24 20 -2 #rect
...
' #txt
Cs0 f141 2016 942 2016 980 #arcP
Cs0 f130 expr out #txt
Cs0 f130 2016 1004 2016 1075 #arcP
...
' #txt
Cs0 f142 2030 928 2029 1088 #arcP
Cs0 f142 1 2120 928 #addKink
Cs0 f142 2 2120 1088 #addKink
...
' #txt
Cs0 f146 2394 690 28 28 14 0 #rect
Cs0 f146 @|AlternativeIcon #fIcon
Cs0 f147 expr out #txt
Cs0 f147 2408 674 2408 690 #arcP
...
Cs0 f148 2390 940 36 24 22 -18 #rect
Cs0 f148 @|RichDialogProcessStepIcon #fIcon
Cs0 f150 expr in #txt
Cs0 f150 2422 704 2421 1088 #arcP
Cs0 f150 1 2728 704 #addKink
Cs0 f150 2 2728 1088 #addKink
...
' #txt
Cs0 f145 2394 770 28 28 14 0 #rect
...
' #txt
Cs0 f152 2408 718 2408 770 #arcP
Cs0 f156 type ch.ivyteam.ivy.workflow.ui.cases.CaseSearch.CaseSearchData #txt
Cs0 f156 callType false #txt
Cs0 f156 inParamDecl '<ch.ivyteam.ivy.security.IPermission aPermission> param;
' #txt
Cs0 f156 inParamNames param #txt
Cs0 f156 inParamTypes '1
1
<ch.ivyteam.ivy.security.IPermission aPermission>
' #txt
Cs0 f156 actionCallTable 'param.aPermission=ch.ivyteam.ivy.security.IPermission.CASE_DESTROY;
' #txt
Cs0 f156 outParamDecl '<> result;
' #txt
Cs0 f156 outParamNames result #txt
Cs0 f156 outParamTypes '1
1
<>
' #txt
Cs0 f156 actionDecl 'ch.ivyteam.ivy.workflow.ui.cases.CaseSearch.CaseSearchData out;
' #txt
Cs0 f156 actionTable 'out=in;
' #txt
Cs0 f156 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>infom the user
...
' #txt
Cs0 f156 2582 884 36 24 20 -2 #rect
Cs0 f156 @|CallSubIcon #fIcon
Cs0 f157 expr in #txt
Cs0 f157 2422 784 2600 884 #arcP
Cs0 f157 1 2600 784 #addKink
Cs0 f157 0 0.7294135661252886 0 0 #arcLabel
Cs0 f153 expr out #txt
Cs0 f153 2600 908 2421 1088 #arcP
Cs0 f153 1 2600 1088 #addKink
Cs0 f153 1 0.07257412274394467 0 0 #arcLabel
...
' #txt
Cs0 f155 2002 738 28 28 14 0 #rect
...
panel.caseHierarchyLayoutTree.getSelectedTreeNode().value instanceof ch.ivyteam.ivy.workflow.ICase' #txt
Cs0 f158 2016 718 2016 738 #arcP
Cs0 f134 expr in #txt
Cs0 f134 outCond in.hasPermissionCaseRead #txt
Cs0 f134 2016 766 2016 796 #arcP
Cs0 f159 type ch.ivyteam.ivy.workflow.ui.cases.CaseSearch.CaseSearchData #txt
Cs0 f159 callType false #txt
Cs0 f159 inParamDecl '<ch.ivyteam.ivy.security.IPermission aPermission> param;
' #txt
Cs0 f159 inParamNames param #txt
Cs0 f159 inParamTypes '1
1
<ch.ivyteam.ivy.security.IPermission aPermission>
' #txt
Cs0 f159 actionCallTable 'param.aPermission=ch.ivyteam.ivy.security.IPermission.CASE_READ;
' #txt
Cs0 f159 outParamDecl '<> result;
' #txt
Cs0 f159 outParamNames result #txt
Cs0 f159 outParamTypes '1
1
<>
' #txt
...
' #txt
Cs0 f159 2174 796 36 24 20 -2 #rect
Cs0 f159 @|CallSubIcon #fIcon
Cs0 f160 expr in #txt
Cs0 f160 2030 752 2192 796 #arcP
Cs0 f160 1 2192 752 #addKink
Cs0 f160 0 0.7030924776439416 0 0 #arcLabel
Cs0 f161 expr out #txt
Cs0 f161 2192 820 2029 1088 #arcP
Cs0 f161 1 2192 1088 #addKink
Cs0 f161 0 0.8711092536861837 0 0 #arcLabel
Cs0 f38 expr out #txt
Cs0 f38 1064 74 786 120 #arcP
Cs0 f38 1 1064 120 #addKink
Cs0 f38 1 0.3617086354357857 0 0 #arcLabel
Cs0 f163 expr out #txt
Cs0 f163 1200 74 786 120 #arcP
Cs0 f163 1 1200 120 #addKink
Cs0 f163 1 0.4201433628302493 0 0 #arcLabel
Cs0 f164 expr out #txt
Cs0 f164 1336 74 786 120 #arcP
Cs0 f164 1 1336 120 #addKink
...
Cs0 f184 1734 284 36 24 20 -2 #rect
...
' #txt
Cs0 f37 1974 142 20 20 13 0 #rect
...
' #txt
Cs0 f165 1742 142 20 20 13 0 #rect
...
Cs0 f170 1966 228 36 24 20 -2 #rect
Cs0 f170 @|RichDialogProcessStepIcon #fIcon
Cs0 f172 expr out #txt
Cs0 f172 1984 300 1984 355 #arcP
Cs0 f173 expr out #txt
Cs0 f173 1984 162 1984 228 #arcP
Cs0 f174 expr out #txt
Cs0 f174 1984 252 1984 276 #arcP
Cs0 f175 expr out #txt
Cs0 f175 1752 308 1752 355 #arcP
Cs0 f36 guid 11B0348993A39376 #txt
...
' #txt
Cs0 f36 1486 54 20 20 13 0 #rect
Cs0 f36 @|RichDialogProcessStartIcon #fIcon
Cs0 f162 expr out #txt
Cs0 f162 1496 74 786 120 #arcP
Cs0 f162 1 1496 120 #addKink
Cs0 f162 1 0.4599395815561867 0 0 #arcLabel
...
Cs0 f176 710 724 36 24 16 -8 #rect
...
' #txt
Cs0 f177 728 702 728 724 #arcP
Cs0 f75 expr out #txt
Cs0 f75 728 748 728 762 #arcP
...
Cs0 f91 1070 852 36 24 20 -2 #rect
...
' #txt
Cs0 f179 742 776 1088 852 #arcP
Cs0 f179 1 1088 776 #addKink
...
' #txt
Cs0 f76 actionDecl 'ch.ivyteam.ivy.workflow.ui.cases.CaseSearch.CaseSearchData out;
' #txt
Cs0 f76 actionTable 'out=in;
' #txt
Cs0 f76 actionCode '// consider the user defined filter
if (in.filterDefined && in.filterEnabled)
{
	out.caseHierarchyContext.propertyFilter = in.caseHierarchyContext.propertyFilter.and(in.caseAvailableFilters.propertyFilter);
}' #txt
Cs0 f76 type ch.ivyteam.ivy.workflow.ui.cases.CaseSearch.CaseSearchData #txt
Cs0 f76 1190 964 36 24 20 -2 #rect
Cs0 f76 @|RichDialogProcessStepIcon #fIcon
Cs0 f95 expr in #txt
...
' #txt
Cs0 f95 728 934 728 970 #arcP
Cs0 f90 expr out #txt
Cs0 f90 944 972 742 984 #arcP
Cs0 f90 1 944 984 #addKink
Cs0 f90 1 0.403812593187997 0 0 #arcLabel
Cs0 f93 expr out #txt
Cs0 f93 1752 162 1752 284 #arcP
Cs0 f94 expr out #txt
Cs0 f94 1088 876 742 920 #arcP
Cs0 f94 1 1088 920 #addKink
...
Cs0 f92 2390 844 36 24 20 -2 #rect
...
' #txt
Cs0 f99 2408 798 2408 844 #arcP
...
' #txt
Cs0 f103 2394 890 28 28 14 0 #rect
Cs0 f103 @|AlternativeIcon #fIcon
Cs0 f104 expr out #txt
Cs0 f104 2408 868 2408 890 #arcP
...
' #txt
Cs0 f100 2408 918 2408 940 #arcP
Cs0 f105 expr in #txt
Cs0 f105 2422 904 2421 1088 #arcP
Cs0 f105 1 2544 904 #addKink
Cs0 f105 2 2544 1088 #addKink
...
' #txt
Cs0 f180 2394 978 28 28 14 -10 #rect
Cs0 f180 @|AlternativeIcon #fIcon
Cs0 f181 expr out #txt
Cs0 f181 2408 964 2408 978 #arcP
...
' #txt
Cs0 f154 2408 1006 2408 1075 #arcP
...
Cs0 f182 2446 1028 36 24 20 -2 #rect
Cs0 f182 @|RichDialogIcon #fIcon
Cs0 f183 expr in #txt
Cs0 f183 2416 998 2450 1028 #arcP
Cs0 f185 expr out #txt
Cs0 f185 2450 1052 2417 1079 #arcP
...
Cs0 f189 574 148 36 24 20 -2 #rect
Cs0 f189 @|RichDialogProcessStepIcon #fIcon
Cs0 f190 expr out #txt
Cs0 f190 592 74 592 148 #arcP
Cs0 f188 expr out #txt
Cs0 f188 592 172 592 275 #arcP
...
' #txt
Cs0 f191 actionCode 'if(in.caseAvailableFilters.#propertyFilter!=null)
{
out.filterDefined = true;
...
>Proto Cs0 .ui2RdDataAction 'out.filterEnabled=panel.applyFilterToggleButton.selected;
out.sortByPriority=panel.sortByPriorityCheckBox.selected;
' #txt
>Proto Cs0 .rdData2UIAction 'panel.applyFilterToggleButton.enabled=in.filterDefined;
...
IF((in.caseAvailableFilters.caseNameFilterIsDefined), 
   "<tr><th align=''left''>" + in.caseAvailableFilters.caseNameFilter.property + "</th><td>" + 
      + in.caseAvailableFilters.caseNameFilter.relationalOperator + " " + 
      in.caseAvailableFilters.caseNameFilter.value + "<br>",
   "")
+

IF((in.caseAvailableFilters.caseStartTimestampFromFilterIsDefined), 
   "<tr><th align=''left''>" + in.caseAvailableFilters.caseStartTimestampFromFilter.property + "</th><td>" + 
      + in.caseAvailableFilters.caseStartTimestampFromFilter.relationalOperator + " " + 
      in.caseAvailableFilters.caseStartTimestampFromFilter.value + "</td></tr>",
   "")
+


IF((in.caseAvailableFilters.caseProcessCategoriesFilterIsDefined), 
   "<tr><th align=''left''>" + in.caseAvailableFilters.caseProcessCategoriesFilter.category.property + "</th><td>" + 
      + in.caseAvailableFilters.caseProcessCategoriesFilter.relationalOperator + " " + 
...
IF ((in.caseAvailableFilters.caseProcessesFilterIsDefined),
   "<tr><th align=''left''>" + in.caseAvailableFilters.caseProcessesFilter.category.property + "</th><td>" + 
      + in.caseAvailableFilters.caseProcessesFilter.relationalOperator + " " + 
...
IF ((in.caseAvailableFilters.caseTypesFilterIsDefined),
   "<tr><th align=''left''>" + in.caseAvailableFilters.caseTypesFilter.category.property + "</th><td>" + 
      + in.caseAvailableFilters.caseTypesFilter.relationalOperator + " " + 
...
IF ((in.caseAvailableFilters.caseSubTypesFilterIsDefined),
   "<tr><th align=''left''>" + in.caseAvailableFilters.caseSubTypesFilter.category.property + "</th><td>" + 
      + in.caseAvailableFilters.caseSubTypesFilter.relationalOperator + " " + 
...
IF((in.caseAvailableFilters.businessMainContactIdFilterIsDefined), 
   "<tr><th align=''left''>" + in.caseAvailableFilters.businessMainContactIdFilter.property + "</th><td>" + 
      + in.caseAvailableFilters.businessMainContactIdFilter.relationalOperator + " " + 
...
IF((in.caseAvailableFilters.businessMainContactNameFilterIsDefined), 
   "<tr><th align=''left''>" + in.caseAvailableFilters.businessMainContactNameFilter.property + "</th><td>" + 
      + in.caseAvailableFilters.businessMainContactNameFilter.relationalOperator + " " + 
...
IF((in.caseAvailableFilters.businessCreatorUserFilterIsDefined), 
   "<tr><th align=''left''>" + in.caseAvailableFilters.businessCreatorUserFilter.property + "</th><td>" + 
      + in.caseAvailableFilters.businessCreatorUserFilter.relationalOperator + " " + 
      in.caseAvailableFilters.businessCreatorUserFilter.value + "</td></tr>",
   "")
+ 
   
IF((in.caseAvailableFilters.businessStartTimestampFromFilterIsDefined), 
   "<tr><th align=''left''>" + in.caseAvailableFilters.businessStartTimestampFromFilter.property + "</th><td>" + 
      + in.caseAvailableFilters.businessStartTimestampFromFilter.relationalOperator + " " + 
      in.caseAvailableFilters.businessStartTimestampFromFilter.value + "</td></tr>",
   "")
+
IF((in.caseAvailableFilters.businessStartTimestampToFilterIsDefined), 
   "<tr><th align=''left''>" + in.caseAvailableFilters.businessStartTimestampToFilter.property + "</th><td>" + 
      + in.caseAvailableFilters.businessStartTimestampToFilter.relationalOperator + " " + 
      in.caseAvailableFilters.businessStartTimestampToFilter.value + "</td></tr>",
   "")   
...
Cs0 f47 out f41 tail #connect
Cs0 f41 head f8 mainIn #connect
...
Cs0 f56 head f1 mainIn #connect
...
Cs0 f89 mainOut f50 tail #connect
Cs0 f50 head f1 mainIn #connect
...
Cs0 f157 head f156 mainIn #connect
Cs0 f156 mainOut f153 tail #connect
...
Cs0 f155 out f160 tail #connect
Cs0 f160 head f159 mainIn #connect
Cs0 f159 mainOut f161 tail #connect
Cs0 f161 head f129 mainIn #connect
...
Cs0 f172 head f169 mainIn #connect
...
Cs0 f36 mainOut f162 tail #connect
...
Cs0 f165 mainOut f93 tail #connect
...
Cs0 f145 out f157 tail #connect
