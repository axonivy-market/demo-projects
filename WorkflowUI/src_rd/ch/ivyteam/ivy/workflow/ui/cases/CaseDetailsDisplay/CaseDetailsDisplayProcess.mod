...
panel.caseIdLabel.toolTipText=in.#fCase is initialized? ivy.cms.co("/ch/ivyteam/ivy/workflow/ui/case/plainStrings/caseId") + ": " + in.fCase.getIdentifier().toString(): "";
panel.caseIdLabel.visible=in.#fCase is initialized;
panel.caseIdTextField.text=in.#fCase is initialized? in.fCase.getIdentifier().toString(): "";
