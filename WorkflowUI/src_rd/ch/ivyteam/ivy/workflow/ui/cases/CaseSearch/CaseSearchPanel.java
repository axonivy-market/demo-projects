...
private RTree getCaseHierarchyLayoutTree() {
	if (caseHierarchyLayoutTree == null) {
		...
		caseHierarchyLayoutTree.setModelConfiguration("{/showTableheader true /autoTableheader false /showtooltip true /showIcons true /version \"3.0\"/dynamicTreeLoadMode \"LOAD_ON_EXPAND\"/emptyTableText \"No tasks found\"/columns {{/patterns {{/result \"result=node.value\"/version \"3.0\"/tooltip \"\"/icon \"result=\\\"/ch/ivyteam/ivy/workflow/ui/case/images/caseHierarchyLayoutRoot16\\\"\"/field \"\"/patternMode \"ALL\"/patternValue \"default\"}{/result \"result=(entry as ch.ivyteam.ivy.workflow.ui.data.cases.CaseHierarchyTreeNodeValue).categoryName\"/version \"3.0\"/tooltip \"\"/icon \"result=\\\"/ch/ivyteam/ivy/workflow/ui/case/images/processCategory16\\\"\"/field \"\"/patternMode \"INFO\"/patternValue \"PROCESS_CATEGORY_CODE\"}{/result \"result=(entry as ch.ivyteam.ivy.workflow.ui.data.cases.CaseHierarchyTreeNodeValue).categoryName\"/version \"3.0\"/tooltip \"\"/icon \"result=\\\"/ch/ivyteam/ivy/workflow/ui/case/images/process16\\\"\"/patternMode \"INFO\"/patternValue \"PROCESS_CODE\"}{/result \"result=(entry as ch.ivyteam.ivy.workflow.ui.data.cases.CaseHierarchyTreeNodeValue).categoryName\"/version \"3.0\"/tooltip \"\"/icon \"result=\\\"/ch/ivyteam/ivy/workflow/ui/case/images/type16\\\"\"/patternMode \"INFO\"/patternValue \"TYPE_CODE\"}{/result \"result=(entry as ch.ivyteam.ivy.workflow.ui.data.cases.CaseHierarchyTreeNodeValue).categoryName\"/version \"3.0\"/tooltip \"\"/icon \"result=\\\"/ch/ivyteam/ivy/workflow/ui/case/images/subType16\\\"\"/patternMode \"INFO\"/patternValue \"SUB_TYPE_CODE\"}{/result \"result=(entry as ch.ivyteam.ivy.workflow.ui.data.cases.CaseHierarchyTreeNodeValue).categoryName\"/version \"3.0\"/tooltip \"\"/icon \"result=\\\"/ch/ivyteam/ivy/workflow/ui/common/workflowPriorities/images/\\\" + \\r\\n(entry as ch.ivyteam.ivy.workflow.ui.data.cases.CaseHierarchyTreeNodeValue).categoryCode + \\\"_16\\\"\"/patternMode \"INFO\"/patternValue \"PRIORITY\"}{/result \"result=(entry as ch.ivyteam.ivy.workflow.ui.data.cases.CaseHierarchyTreeNodeValue).categoryName\"/version \"3.0\"/tooltip \"\"/icon \"result=\\\"/ch/ivyteam/ivy/workflow/ui/case/images/businessStart16\\\"\"/patternMode \"INFO\"/patternValue \"BUSINESS_START_TIMESTAMP\"}{/result \"result=(entry as ch.ivyteam.ivy.workflow.ui.data.cases.CaseHierarchyTreeNodeValue).categoryName\"/version \"3.0\"/tooltip \"\"/icon \"result=\\\"/ch/ivyteam/ivy/workflow/ui/case/images/businessContact16\\\"\"/patternMode \"INFO\"/patternValue \"BUSINESS_MAIN_CONTACT_ID\"}{/result \"result=(entry as ch.ivyteam.ivy.workflow.ui.data.cases.CaseHierarchyTreeNodeValue).categoryName\"/version \"3.0\"/tooltip \"\"/icon \"result=\\\"/ch/ivyteam/ivy/workflow/ui/case/images/businessCreatorUser16\\\"\"/columnStyle \"\"/patternMode \"INFO\"/patternValue \"BUSINESS_CREATOR_USER\"}{/result \"result=entry.getName()\"/version \"3.0\"/tooltip \"\"/icon \"result=\\\"/ch/ivyteam/ivy/workflow/ui/case/images/CASE_ID16\\\"\\r\\n\\r\\n/*\\r\\n\\\"/ch/ivyteam/ivy/workflow/ui/case/images/\\\" + \\r\\n\\t(ch.ivyteam.ivy.workflow.ui.utils.WorkflowUIAccessPermissionHandler.isSessionUserTeamManagerOfCaseAsSystemUser(entry)? \\r\\n\\t\\\"CASE_IDTeamManager16\\\": \\r\\n\\t\\\"CASE_ID16\\\")\\r\\n*/\"/header \"\"/columnStyle \"wfCase\"/patternMode \"INSTANCE\"/patternValue \"ch.ivyteam.ivy.workflow.ICase\"}}/version \"3.0\"}}}");
		caseHierarchyLayoutTree.setName("caseHierarchyLayoutTree");
		caseHierarchyLayoutTree.setName("caseHierarchyLayoutTree");
