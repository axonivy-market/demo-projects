[Ivy]
[>Created: Fri Aug 01 15:18:00 CEST 2008]
11AE9CE89D43B950 3.10 #module
...
<elementInfo>
    <language>
        <name>businessStartTimestampFromCheckBoxSelected</name>
        <nameStyle>42,5,6,9
</nameStyle>
    </language>
</elementInfo>
' #txt
Cs0 f3 guid 11A111AE20E4BD60 #txt
Cs0 f3 type ch.ivyteam.ivy.workflow.ui.cases.CaseFiltersSelect.CaseFiltersSelectData #txt
Cs0 f3 actionDecl 'ch.ivyteam.ivy.workflow.ui.cases.CaseFiltersSelect.CaseFiltersSelectData out;
' #txt
Cs0 f3 actionTable 'out=in;
' #txt
Cs0 f3 actionCode 'panel.businessStartTimestampFromDatePicker.enabled = 
	panel.businessStartTimestampFromCheckBox.isSelected();' #txt
Cs0 f3 630 46 20 20 13 0 #rect
Cs0 f3 @|RichDialogProcessStartIcon #fIcon
Cs0 @RichDialogProcessStart f4 '' #zField
Cs0 f4 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>businessStartTimestampToCheckBoxSelected</name>
        <nameStyle>40,5,6,9
</nameStyle>
    </language>
</elementInfo>
' #txt
Cs0 f4 guid 11A111AE9FF3496B #txt
Cs0 f4 type ch.ivyteam.ivy.workflow.ui.cases.CaseFiltersSelect.CaseFiltersSelectData #txt
Cs0 f4 actionDecl 'ch.ivyteam.ivy.workflow.ui.cases.CaseFiltersSelect.CaseFiltersSelectData out;
' #txt
Cs0 f4 actionTable 'out=in;
' #txt
Cs0 f4 actionCode 'panel.businessStartTimestampToDatePicker.enabled = 
	panel.businessStartTimestampToCheckBox.isSelected();' #txt
Cs0 f4 702 78 20 20 13 0 #rect
Cs0 f4 @|RichDialogProcessStartIcon #fIcon
Cs0 @RichDialogProcessEnd f5 '' #zField
Cs0 f5 type ch.ivyteam.ivy.workflow.ui.cases.CaseFiltersSelect.CaseFiltersSelectData #txt
Cs0 f5 627 355 26 26 14 0 #rect
Cs0 f5 @|RichDialogProcessEndIcon #fIcon
Cs0 @PushWFArc f6 '' #zField
Cs0 f6 expr out #txt
Cs0 f6 640 66 640 355 #arcP
Cs0 @PushWFArc f7 '' #zField
Cs0 f7 expr out #txt
Cs0 f7 712 98 653 368 #arcP
Cs0 f7 1 712 368 #addKink
Cs0 f7 0 0.8426865452706812 0 0 #arcLabel
...
RelationalOperator relOpCategory2 = ch.ivyteam.logicalexpression.RelationalOperator.UNEQUAL;
...
RelationalOperator relOpProcess2 = ch.ivyteam.logicalexpression.RelationalOperator.UNEQUAL;
...
RelationalOperator relOpType2 = ch.ivyteam.logicalexpression.RelationalOperator.UNEQUAL;
...
RelationalOperator relOpSubType2 = ch.ivyteam.logicalexpression.RelationalOperator.UNEQUAL;
...
// case name
out.caseNameRelationalOperatorsList = [RelationalOperator.EQUAL_IGNORE_CASE, RelationalOperator.LIKE];

// business main contact id
out.businessMainContactIdRelationalOperatorsList = [RelationalOperator.EQUAL_IGNORE_CASE, RelationalOperator.LIKE];

// business main contact name
out.businessMainContactNameRelationalOperatorsList = [RelationalOperator.EQUAL_IGNORE_CASE, RelationalOperator.LIKE];

// business creator user
out.businessCreatorUserRelationalOperatorsList = [RelationalOperator.EQUAL_IGNORE_CASE, RelationalOperator.LIKE];
' #txt
...
Cs0 f24 expr in #txt
Cs0 f24 outCond '!(panel.caseProcessCategoriesComboBox.selectedListEntry as ch.ivyteam.ivy.workflow.ui.data.cases.CaseHierarchyTreeNodeValue).categoryName.equals("ALL")' #txt
...
Cs0 f77 expr in #txt
Cs0 f77 outCond '!(panel.caseProcessesComboBox.selectedListEntry as ch.ivyteam.ivy.workflow.ui.data.cases.CaseHierarchyTreeNodeValue).categoryName.equals("ALL")' #txt
...
Cs0 f70 expr in #txt
Cs0 f70 outCond '!(panel.caseTypesComboBox.selectedListEntry as ch.ivyteam.ivy.workflow.ui.data.cases.CaseHierarchyTreeNodeValue).categoryName.equals("ALL")' #txt
...
if (panel.caseStartTimestampFromCheckBox.isSelected())
{
	out.caseAvailableFilters.caseStartTimestampFromFilter.property = CaseProperty.START_TIMESTAMP;
	out.caseAvailableFilters.caseStartTimestampFromFilter.relationalOperator = RelationalOperator.EQUAL_OR_LARGER;
	out.caseAvailableFilters.caseStartTimestampFromFilter.value = new Date(panel.caseStartTimestampFromDatePicker.getDate()).toString();
	
	IPropertyFilter caseStartTimestampFromPropertyFilter = 
						ivy.wf.createCasePropertyFilter(out.caseAvailableFilters.caseStartTimestampFromFilter.property,
																						out.caseAvailableFilters.caseStartTimestampFromFilter.relationalOperator,
																						out.caseAvailableFilters.caseStartTimestampFromFilter.value);
	
	
	out.caseAvailableFilters.propertyFilter = (out.#caseAvailableFilters.#propertyFilter is initialized? 
																								out.caseAvailableFilters.propertyFilter.and(caseStartTimestampFromPropertyFilter):
																								caseStartTimestampFromPropertyFilter);

	out.caseAvailableFilters.caseStartTimestampFromFilterIsDefined = true;
}
else
{
		out.caseAvailableFilters.caseStartTimestampFromFilterIsDefined = false;
}
...
if (panel.caseProcessCategoriesComboBox.getSelectedListEntry() != null &&
	!(panel.caseProcessCategoriesComboBox.getSelectedListEntry() as CaseHierarchyTreeNodeValue).categoryCode.equals("")) 		
{
...
if (panel.caseProcessesComboBox.getSelectedListEntry() != null && !(panel.caseProcessesComboBox.getSelectedListEntry() as CaseHierarchyTreeNodeValue).categoryCode.equals(""))
{
...
if (panel.caseTypesComboBox.getSelectedListEntry() != null && !(panel.caseTypesComboBox.getSelectedListEntry() as CaseHierarchyTreeNodeValue).categoryCode.equals(""))
{
...
if (panel.caseSubTypesComboBox.getSelectedListEntry() != null && !(panel.caseSubTypesComboBox.getSelectedListEntry() as CaseHierarchyTreeNodeValue).categoryCode.equals(""))
{
...
// business start time from and to
out.caseAvailableFilters.businessStartTimestampFromFilterIsDefined = false;
out.caseAvailableFilters.businessStartTimestampToFilterIsDefined = false;	


if (panel.businessStartTimestampFromCheckBox.isSelected() && !panel.businessStartTimestampToCheckBox.isSelected())
{
	out.caseAvailableFilters.businessStartTimestampFromFilter.property = CaseProperty.BUSINESS_START_TIMESTAMP;
	out.caseAvailableFilters.businessStartTimestampFromFilter.relationalOperator = RelationalOperator.EQUAL_OR_LARGER;
	out.caseAvailableFilters.businessStartTimestampFromFilter.value = new Date(panel.businessStartTimestampFromDatePicker.getDate()).toString();
	
	
	out.caseAvailableFilters.propertyFilter = (out.#caseAvailableFilters.#propertyFilter is initialized? 
		out.caseAvailableFilters.propertyFilter.and(out.caseAvailableFilters.businessStartTimestampFromFilter.property, 
																												out.caseAvailableFilters.businessStartTimestampFromFilter.relationalOperator, 
																												out.caseAvailableFilters.businessStartTimestampFromFilter.value):
		ivy.wf.createCasePropertyFilter(out.caseAvailableFilters.businessStartTimestampFromFilter.property, 
																		out.caseAvailableFilters.businessStartTimestampFromFilter.relationalOperator, 
																		out.caseAvailableFilters.businessStartTimestampFromFilter.value));
	
	out.caseAvailableFilters.businessStartTimestampFromFilterIsDefined = true;
}
else
{
	// business start time to
	if (panel.businessStartTimestampFromCheckBox.isSelected() && panel.businessStartTimestampToCheckBox.isSelected())
	{
		out.caseAvailableFilters.businessStartTimestampFromFilter.property = CaseProperty.BUSINESS_START_TIMESTAMP;
		out.caseAvailableFilters.businessStartTimestampFromFilter.relationalOperator = RelationalOperator.EQUAL_OR_LARGER;
		...
		out.caseAvailableFilters.businessStartTimestampToFilter.property = CaseProperty.BUSINESS_START_TIMESTAMP;
		out.caseAvailableFilters.businessStartTimestampToFilter.relationalOperator = RelationalOperator.EQUAL_OR_SMALLER;
		out.caseAvailableFilters.businessStartTimestampToFilter.value = new Date(panel.businessStartTimestampToDatePicker.getDate()).toString();
		
		
		IPropertyFilter propertyFilterFromTo = 
						ivy.wf.createCasePropertyFilter(out.caseAvailableFilters.businessStartTimestampFromFilter.property, 
																						out.caseAvailableFilters.businessStartTimestampFromFilter.relationalOperator, 
																						out.caseAvailableFilters.businessStartTimestampFromFilter.value).and(
																									out.caseAvailableFilters.businessStartTimestampToFilter.property, 
																									out.caseAvailableFilters.businessStartTimestampToFilter.relationalOperator, 
																									out.caseAvailableFilters.businessStartTimestampToFilter.value);
																						
		out.caseAvailableFilters.propertyFilter = (out.#caseAvailableFilters.#propertyFilter is initialized? 
			out.caseAvailableFilters.propertyFilter.and(propertyFilterFromTo):propertyFilterFromTo);
		
		out.caseAvailableFilters.businessStartTimestampFromFilterIsDefined = true;
		out.caseAvailableFilters.businessStartTimestampToFilterIsDefined = true;
	}
}
...
' #txt
Cs0 f62 actionDecl 'ch.ivyteam.ivy.workflow.ui.cases.CaseFiltersSelect.CaseFiltersSelectData out;
' #txt
Cs0 f62 actionTable 'out=in;
' #txt
Cs0 f62 actionCode 'import com.ulcjava.base.application.border.ULCTitledBorder;

(panel.caseFiltersGridBagLayoutPane.getBorder() as ULCTitledBorder).setTitle(ivy.cms.co("/ch/ivyteam/ivy/workflow/ui/case/plainStrings/caseFilters"));
...
(panel.caseCategorizationFiltersGridBagLayoutPane.getBorder() as ULCTitledBorder).setTitle(ivy.cms.co("/ch/ivyteam/ivy/workflow/ui/case/plainStrings/caseCategorizationHierarchy"));' #txt
Cs0 f62 type ch.ivyteam.ivy.workflow.ui.cases.CaseFiltersSelect.CaseFiltersSelectData #txt
Cs0 f62 462 156 36 24 20 -2 #rect
Cs0 f62 @|RichDialogProcessStepIcon #fIcon
Cs0 @PushWFArc f64 '' #zField
Cs0 f64 expr out #txt
Cs0 f64 480 58 480 156 #arcP
Cs0 f64 0 0.9405939487439562 0 0 #arcLabel
Cs0 @PushWFArc f48 '' #zField
Cs0 f48 expr out #txt
Cs0 f48 480 180 480 244 #arcP
...
Cs0 f18 mainOut f64 tail #connect
Cs0 f64 head f62 mainIn #connect
