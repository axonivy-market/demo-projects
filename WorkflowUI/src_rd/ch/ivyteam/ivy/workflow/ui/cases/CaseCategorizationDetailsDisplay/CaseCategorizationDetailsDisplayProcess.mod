[Ivy]
[>Created: Tue Jun 15 15:07:28 CEST 2010]
11850C944B448AE7 3.12 #module
...
Ts0 f23 344 178 124 367 #arcP
Ts0 f23 1 344 352 #addKink
Ts0 f23 1 0.10069066014794331 0 0 #arcLabel
...
>Proto Ts0 .rdData2UIAction 'panel.businessMilestoneTimestampLabel.visible=in.#fCase.getBusinessMilestoneTimestamp() is initialized;
panel.businessMilestoneTimestampTextField.text=in.#fCase.getBusinessMilestoneTimestamp() is initialized? in.fCase.getBusinessMilestoneTimestamp().format(): "";
panel.businessMilestoneTimestampTextField.visible=in.#fCase.getBusinessMilestoneTimestamp() is initialized;
panel.businessStartTimestampLabel.visible=in.#fCase.getBusinessStartTimestamp() is initialized;
panel.businessStartTimestampTextField.text=(in.#fCase.getBusinessStartTimestamp() is initialized? in.fCase.getBusinessStartTimestamp().format(""): "");
panel.businessStartTimestampTextField.visible=in.#fCase.getBusinessStartTimestamp() is initialized;
panel.caseDescriptionLabel.visible=(in.#fCase.#description is initialized);
...
panel.caseIdLabel.toolTipText=(in.#fCase is initialized? ivy.cms.co("/ch/ivyteam/ivy/workflow/ui/case/plainStrings/caseId") + ": " + in.fCase.getId().toString(): "n/a");
panel.caseIdTextField.text=(in.#fCase is initialized? in.fCase.getId().toString(): "n/a");
...
panel.casePriorityLabel.iconUri=(in.#fCase is initialized? "/ch/ivyteam/ivy/workflow/ui/common/workflowPriorities/images/" + in.fCase.getPriority().intValue() + "_16": "");
panel.casePriorityLabel.toolTipText=(in.#fCase is initialized? ivy.cms.co("/ch/ivyteam/ivy/workflow/ui/common/workflowPriorities/plainStrings/" + in.fCase.getPriority().intValue()): "n/a");
panel.casePriorityLabel.visible=in.#fCase.getBusinessPriority() is initialized;
panel.casePriorityTextField.text=(in.#fCase is initialized? ivy.cms.co("/ch/ivyteam/ivy/workflow/ui/common/workflowPriorities/plainStrings/" + in.fCase.getPriority().intValue()): "n/a");
panel.casePriorityTextField.visible=in.#fCase.getBusinessPriority() is initialized;
...
panel.caseProcessCategoryLabel.visible=(in.#fCase.getProcessCategoryCode() is initialized || in.#fCase.getProcessCategoryName() is initialized);
...
panel.caseProcessLabel.visible=(in.#fCase.getProcessCode() is initialized || in.#fCase.getProcessName() is initialized);
...
panel.caseStartByTextField.text=(in.#fCase.getBusinessCreatorUser() is initialized? in.fCase.getBusinessCreatorUser(): in.fCase.getCreatorUserName());
panel.caseStartByTextField.visible=in.#fCase.getBusinessCreatorUser() is initialized;
panel.caseStartedByLabel.visible=in.#fCase.getBusinessCreatorUser() is initialized;
panel.caseStateLabel.iconUri="/ch/ivyteam/ivy/workflow/ui/case/caseState/images/" + in.fCase.getState() + "16";
panel.caseStateLabel.visible=in.#fCase.getState() is initialized;
panel.caseStateTextField.text=(in.#fCase.getState() is initialized? ivy.cms.co("/ch/ivyteam/ivy/workflow/ui/case/caseState/plainStrings/"  + in.fCase.getState()): "n/a");
panel.caseStateTextField.visible=in.#fCase.getState() is initialized;
...
panel.caseSubTypeLabel.visible=(in.#fCase.getSubTypeCode() is initialized || in.#fCase.getSubTypeName() is initialized);
...
panel.caseTypeLabel.visible=(in.#fCase.getTypeCode() is initialized || in.#fCase.getTypeName() is initialized);
