...
panel.caseIdLabel.toolTipText=(in.#fCase is initialized? ivy.cms.co("/ch/ivyteam/ivy/workflow/ui/case/plainStrings/caseId") + ": " + in.fCase.getIdentifier().toString(): "n/a");
