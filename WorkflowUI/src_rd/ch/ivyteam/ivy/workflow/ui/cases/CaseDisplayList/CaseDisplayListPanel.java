...
private RTableWithExcelExport getCasesTable() {
	if (casesTable == null) {
		...
		casesTable.setModelConfiguration("{/showTableheader true /autoTableheader false /showtooltip false /showIcons true /version \"3.0\"/emptyTableText \"\"/columns {{/result \"result=entry.getBusinessPriority() is initialized? \\r\\n\\tivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/caseRisk/plainStrings/\\\" + Enum.valueOf(ch.ivyteam.ivy.workflow.WorkflowPriority.class, entry.getBusinessPriority()).ordinal() )\\r\\n\\t: \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"result=entry.getBusinessPriority() is initialized? \\r\\n\\t\\t\\\"/ch/ivyteam/ivy/workflow/ui/common/workflowPriorities/images/\\\" + Enum.valueOf(ch.ivyteam.ivy.workflow.WorkflowPriority.class, entry.getBusinessPriority()).ordinal() + \\\"_16\\\"\\r\\n\\t\\t: \\\"\\\"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/otherBusinessData/plainStrings/businessPriorityShort\\\")\"/field \"\"/editable \"\"/condition \"\"/columnWidth \"100\"/columnStyle \"\"/cellWidget \"\"}{/result \"result=ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/caseState/plainStrings/\\\"  + entry.getState())\"/version \"3.0\"/tooltip \"\"/icon \"result=\\\"/ch/ivyteam/ivy/workflow/ui/case/caseState/images/\\\" + entry.getState() + \\\"16\\\"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/common/plainStrings/stateShort\\\")\"/field \"\"/columnWidth \"100\"/columnStyle \"\"}{/result \"result=entry.getName()\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/plainStrings/case\\\")\"/field \"\"/columnWidth \"350\"/columnStyle \"wfCase\"}{/result \"result=entry.getBusinessMainContactId() is initialized? entry.getBusinessMainContactId(): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/businessMainContact/plainStrings/idLong\\\")\"/field \"\"/editable \"\"/condition \"\"/columnWidth \"80\"/columnStyle \"\"/cellWidget \"\"}{/result \"result=entry.getBusinessMainContactType() is initialized? entry.getBusinessMainContactType(): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/businessMainContact/plainStrings/typeLong\\\")\"/field \"\"/editable \"\"/condition \"\"/columnWidth \"80\"/columnStyle \"\"/cellWidget \"\"}{/result \"result=entry.getBusinessMainContactName() is initialized? entry.getBusinessMainContactName(): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/businessMainContact/plainStrings/nameLong\\\")\"/field \"\"/editable \"\"/condition \"\"/columnWidth \"250\"/columnStyle \"\"/cellWidget \"\"}{/result \"result=entry.getBusinessObjectCode() is initialized? entry.getBusinessObjectCode(): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/businessObject/plainStrings/codeShort\\\")\"/field \"\"/editable \"\"/condition \"\"/columnWidth \"80\"/columnStyle \"\"/cellWidget \"\"}{/result \"result=entry.getBusinessObjectName() is initialized? entry.getBusinessObjectName(): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/businessObject/plainStrings/nameShort\\\")\"/field \"\"/editable \"\"/condition \"\"/columnWidth \"200\"/columnStyle \"\"/cellWidget \"\"}{/result \"result=entry.getBusinessStartTimestamp() is initialized? entry.getBusinessStartTimestamp().format(ivy.var.xivy_workflow_ui_restricted_dateTimeFormatPattern): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/otherBusinessData/plainStrings/businessStartDateTimeLong\\\")\"/field \"\"/editable \"\"/condition \"\"/columnWidth \"100\"/columnStyle \"date\"/cellWidget \"\"}{/result \"result=entry.getBusinessMilestoneTimestamp() is initialized? entry.getBusinessMilestoneTimestamp().format(ivy.var.xivy_workflow_ui_restricted_dateFormatPattern): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/otherBusinessData/plainStrings/businessMilestoneDateTimeLong\\\")\"/field \"\"/editable \"\"/condition \"\"/columnWidth \"80\"/columnStyle \"date\"/cellWidget \"\"}{/result \"result=entry.getBusinessCreatorUser() is initialized? entry.getBusinessCreatorUser(): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/otherBusinessData/plainStrings/businessCreatorUserShort\\\")\"/field \"\"/editable \"\"/condition \"\"/columnWidth \"100\"/columnStyle \"\"/cellWidget \"\"}{/result \"result=entry.getProcessCategoryName() is initialized? entry.getProcessCategoryName(): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/plainStrings/caseProcessCategoryName\\\")\"/field \"\"/columnWidth \"150\"/columnStyle \"\"}{/result \"result=entry.getProcessName() is initialized? entry.getProcessName(): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/plainStrings/caseProcessName\\\")\"/field \"\"/columnWidth \"150\"/columnStyle \"\"}{/result \"result=entry.getTypeName() is initialized? entry.getTypeName(): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/plainStrings/caseTypeName\\\")\"/field \"\"/columnWidth \"150\"/columnStyle \"\"}{/result \"result=entry.getSubTypeName() is initialized? entry.getSubTypeName(): \\\"\\\"\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/plainStrings/caseSubTypeName\\\")\"/field \"\"/columnWidth \"150\"/columnStyle \"\"}{/result \"result=entry.getIdentifier()\"/version \"3.0\"/tooltip \"\"/icon \"result=\\\"/ch/ivyteam/ivy/workflow/ui/case/images/CASE_ID16\\\"\\r\\n\\r\\n/*\\r\\n\\\"/ch/ivyteam/ivy/workflow/ui/case/images/\\\" + \\r\\n\\t(ch.ivyteam.ivy.workflow.ui.utils.WorkflowUIAccessPermissionHandler.isSessionUserTeamManagerOfCaseAsSystemUser(entry)? \\r\\n\\t\\\"CASE_IDTeamManager16\\\": \\r\\n\\t\\\"CASE_ID16\\\")\\r\\n*/\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/common/plainStrings/id\\\")\"/field \"\"/condition \"\"/columnWidth \"100\"/columnStyle \"\"/cellWidget \"\"}}}");
