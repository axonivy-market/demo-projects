...
private RToolBar getCaseActionsToolBar() {
	if (caseActionsToolBar == null) {
		...
		caseActionsToolBar.setStyleProperties("{/fill \"HORIZONTAL\"/weightX \"1\"}");
...
private RTable getCasesTable() {
	if (casesTable == null) {
		...
		casesTable.setModelConfiguration("{/showTableheader true /autoTableheader false /showtooltip true /showIcons true /version \"3.0\"/emptyTableText \"No cases to display\"/columns {{/result \"result=entry.getIdentifier()\"/version \"3.0\"/tooltip \"result=entry.getIdentifier()\"/icon \"result=\\\"/ch/ivyteam/ivy/workflow/ui/case/images/CASE_ID16\\\"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/common/plainStrings/id\\\")\"/field \"\"/columnWidth \"60\"}{/result \"result=entry.getName()\"/version \"3.0\"/tooltip \"result=entry.getName()\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/plainStrings/case\\\")\"/field \"\"/columnWidth \"300\"/columnStyle \"\"}{/result \"result=entry.getState()\"/version \"3.0\"/tooltip \"result=entry.getState()\"/icon \"result=\\\"/ch/ivyteam/ivy/workflow/ui/case/images/caseState\\\" + entry.getState() + \\\"16\\\"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/plainStrings/caseState\\\")\"/field \"\"/columnWidth \"20\"}{/result \"result=(entry.getStartTimestamp() is initialized? new DateTime(entry.getStartTimestamp()).format(): \\\"n/a\\\")\"/version \"3.0\"/tooltip \"result=(entry.getStartTimestamp() is initialized? new DateTime(entry.getStartTimestamp()).format(): \\\"n/a\\\")\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/common/plainStrings/startDate\\\")\"/field \"\"/columnWidth \"120\"}{/result \"result=entry.getCreatorUserName()\"/version \"3.0\"/tooltip \"result=entry.getCreatorUserName()\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/plainStrings/caseCreatorUserName\\\")\"/field \"\"}{/result \"result=(entry.getProcessCategoryName() is initialized? entry.getProcessCategoryName(): \\\"n/a\\\")\"/version \"3.0\"/tooltip \"result=(entry.getProcessCategoryName() is initialized? entry.getProcessCategoryName(): \\\"n/a\\\")\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/plainStrings/caseProcessCategoryName\\\")\"/field \"\"}{/result \"result=(entry.getProcessName() is initialized? entry.getProcessName(): \\\"n/a\\\")\"/version \"3.0\"/tooltip \"result=(entry.getProcessName() is initialized? entry.getProcessName(): \\\"n/a\\\")\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/plainStrings/caseProcessName\\\")\"/field \"\"}{/result \"result=(entry.getTypeName() is initialized? entry.getTypeName(): \\\"n/a\\\")\"/version \"3.0\"/tooltip \"result=(entry.getTypeName() is initialized? entry.getTypeName(): \\\"n/a\\\")\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/plainStrings/caseTypeName\\\")\"/field \"\"}{/result \"result=(entry.getSubTypeName() is initialized? entry.getSubTypeName(): \\\"n/a\\\")\"/version \"3.0\"/tooltip \"result=(entry.getSubTypeName() is initialized? entry.getSubTypeName(): \\\"n/a\\\")\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/workflow/ui/case/plainStrings/caseSubTypeName\\\")\"/field \"\"}}}");
...
private RToolBar getFindCaseToolBar() {
	if (findCaseToolBar == null) {
		...
		findCaseToolBar.setStyleProperties("{/fill \"HORIZONTAL\"/weightX \"1\"}");
