...
<%
String urlToStart= java.net.URLDecoder.decode(ivy.html.get("in.url"), "UTF-8");
String tmpMsg=ivy.html.get("in.message");
%>
<html>
<head> 
...
%>
	...
	<span id="back_links">	
		<br>		
		<p><%=ivy.cms.co("/labels/common/back")%> <a style="font-size: 8pt;color: #333333;text-decoration: none;border: 0px;font-weight: bold;" href='javascript:location.replace("<%=ivy.html.startref("13EACA2A989BCC3D/DefaultApplicationHomePage.ivp")%>")'>&raquo; <%=ivy.cms.co("/navLabels/home")%></a>
	</span>
</div>
