...
/**
 * Helpers to use a fixed (portable) version of firefox. 
 * So selenium doesn't need an update to be compatible with the current firefox version under test.
 * 
 * <p>The portable firefox must be installed as follows:<pre>
 ...
 * - start firefox several times -> no updates should be installed</pre>
 */
