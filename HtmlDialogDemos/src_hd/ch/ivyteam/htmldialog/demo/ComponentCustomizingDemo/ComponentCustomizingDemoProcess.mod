...
Cs0 f0 type ch.ivyteam.htmldialog.demo.ComponentCustomizingDemo.ComponentCustomizingDemoData #txt
...
Cs0 f1 type ch.ivyteam.htmldialog.demo.ComponentCustomizingDemo.ComponentCustomizingDemoData #txt
Cs0 f1 86 150 20 20 13 0 #rect
Cs0 f1 @|RichDialogProcessEndIcon #fIcon
Cs0 f2 expr out #txt
Cs0 f2 96 74 96 150 #arcP
Cs0 f3 guid 13C62A24F9EDA5DC #txt
Cs0 f3 type ch.ivyteam.htmldialog.demo.ComponentCustomizingDemo.ComponentCustomizingDemoData #txt
Cs0 f3 actionDecl 'ch.ivyteam.htmldialog.demo.ComponentCustomizingDemo.ComponentCustomizingDemoData out;
' #txt
...
Cs0 f4 type ch.ivyteam.htmldialog.demo.ComponentCustomizingDemo.ComponentCustomizingDemoData #txt
