...
Ms0 f5 type ch.ivyteam.htmldialog.demo.input.MultiViewDemo.MultiViewDemoData #txt
...
Ms0 f10 actionDecl 'ch.ivyteam.htmldialog.demo.input.MultiViewDemo.MultiViewDemoData out;
' #txt
Ms0 f10 actionTable 'out=in;
out.nextView="Invoice";
' #txt
Ms0 f10 type ch.ivyteam.htmldialog.demo.input.MultiViewDemo.MultiViewDemoData #txt
Ms0 f10 182 236 36 24 20 -2 #rect
Ms0 f10 @|StepIcon #fIcon
Ms0 f11 actionDecl 'ch.ivyteam.htmldialog.demo.input.MultiViewDemo.MultiViewDemoData out;
' #txt
Ms0 f11 actionTable 'out=in;
out.nextView="CreditCard";
' #txt
Ms0 f11 type ch.ivyteam.htmldialog.demo.input.MultiViewDemo.MultiViewDemoData #txt
Ms0 f11 254 236 36 24 20 -2 #rect
Ms0 f11 @|StepIcon #fIcon
Ms0 f12 actionDecl 'ch.ivyteam.htmldialog.demo.input.MultiViewDemo.MultiViewDemoData out;
' #txt
Ms0 f12 actionTable 'out=in;
out.nextView="Summary";
' #txt
Ms0 f12 type ch.ivyteam.htmldialog.demo.input.MultiViewDemo.MultiViewDemoData #txt
Ms0 f12 398 236 36 24 20 -2 #rect
Ms0 f12 @|StepIcon #fIcon
Ms0 f13 type ch.ivyteam.htmldialog.demo.input.MultiViewDemo.MultiViewDemoData #txt
...
Ms0 f21 actionDecl 'ch.ivyteam.htmldialog.demo.input.MultiViewDemo.MultiViewDemoData out;
' #txt
Ms0 f21 actionTable 'out=in;
out.nextView="CreditCardProcessing";
' #txt
Ms0 f21 type ch.ivyteam.htmldialog.demo.input.MultiViewDemo.MultiViewDemoData #txt
Ms0 f21 462 236 36 24 20 -2 #rect
Ms0 f21 @|StepIcon #fIcon
Ms0 f22 expr out #txt
Ms0 f22 462 260 282 377 #arcP
Ms0 f23 actionDecl 'ch.ivyteam.htmldialog.demo.input.MultiViewDemo.MultiViewDemoData out;
' #txt
Ms0 f23 actionTable 'out=in;
out.nextView="Summary";
' #txt
Ms0 f23 type ch.ivyteam.htmldialog.demo.input.MultiViewDemo.MultiViewDemoData #txt
