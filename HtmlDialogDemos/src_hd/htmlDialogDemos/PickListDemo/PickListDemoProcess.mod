...
Ps0 f0 type htmlDialogDemos.PickListDemo.PickListDemoData #txt
...
Ps0 f1 type htmlDialogDemos.PickListDemo.PickListDemoData #txt
Ps0 f1 86 150 20 20 13 0 #rect
Ps0 f1 @|RichDialogProcessEndIcon #fIcon
Ps0 f3 type htmlDialogDemos.PickListDemo.PickListDemoData #txt
Ps0 f3 processCall 'Functional Processes/InitPersons:initPerson()' #txt
Ps0 f3 doCall true #txt
Ps0 f3 requestActionDecl '<> param;
' #txt
Ps0 f3 responseActionDecl 'htmlDialogDemos.PickListDemo.PickListDemoData out;
' #txt
...
Ps0 f7 type htmlDialogDemos.PickListDemo.PickListDemoData #txt
Ps0 f7 actionDecl 'htmlDialogDemos.PickListDemo.PickListDemoData out;
' #txt
...
Ps0 f8 type htmlDialogDemos.PickListDemo.PickListDemoData #txt
