...
Do0 @StartRequest f47 '' #zField
Do0 @EndTask f48 '' #zField
Do0 @RichDialog f49 '' #zField
Do0 @PushWFArc f50 '' #zField
Do0 @PushWFArc f51 '' #zField
Do0 @StartRequest f52 '' #zField
Do0 @EndTask f53 '' #zField
...
Do0 @StartRequest f62 '' #zField
Do0 @RichDialog f63 '' #zField
...
Do0 f47 actionDecl 'htmlDialogDemos.Data out;
' #txt
Do0 f47 guid 13B6BDAFCF828707 #txt
Do0 f47 requestEnabled true #txt
Do0 f47 triggerEnabled false #txt
Do0 f47 callSignature ComponentDemo() #txt
Do0 f47 persist false #txt
Do0 f47 startName 'Component Demo' #txt
Do0 f47 taskData '#
...
type.name=
' #txt
Do0 f47 showInStartList 1 #txt
Do0 f47 taskAndCaseSetupAction 'import ch.ivyteam.ivy.workflow.TaskUpdateDefinition;
ch.ivyteam.ivy.workflow.TaskUpdateDefinition taskUpdDef = new ch.ivyteam.ivy.workflow.TaskUpdateDefinition();
import ch.ivyteam.ivy.request.impl.DefaultCalendarProxy;
DefaultCalendarProxy calendarProxy = ivy.cal as DefaultCalendarProxy;
taskUpdDef.setPriority(ch.ivyteam.ivy.workflow.WorkflowPriority.valueOf(2));
...
engine.updateCurrentTask(taskUpdDef);
' #txt
Do0 f47 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
Do0 f49 responseActionDecl 'htmlDialogDemos.Data out;
' #txt
Do0 f49 responseMappingAction 'out=in;
' #txt
Do0 f49 windowConfiguration '* ' #txt
...
Do0 f52 actionDecl 'htmlDialogDemos.Data out;
' #txt
Do0 f52 guid 13C3DAD7F42D9A85 #txt
Do0 f52 requestEnabled true #txt
Do0 f52 triggerEnabled false #txt
Do0 f52 callSignature BeanValidationDemo() #txt
Do0 f52 persist false #txt
Do0 f52 startName 'Bean Validation Demo' #txt
Do0 f52 taskData '#
...
type.name=
' #txt
Do0 f52 showInStartList 1 #txt
Do0 f52 taskAndCaseSetupAction 'import ch.ivyteam.ivy.workflow.TaskUpdateDefinition;
ch.ivyteam.ivy.workflow.TaskUpdateDefinition taskUpdDef = new ch.ivyteam.ivy.workflow.TaskUpdateDefinition();
import ch.ivyteam.ivy.request.impl.DefaultCalendarProxy;
DefaultCalendarProxy calendarProxy = ivy.cal as DefaultCalendarProxy;
taskUpdDef.setPriority(ch.ivyteam.ivy.workflow.WorkflowPriority.valueOf(2));
...
engine.updateCurrentTask(taskUpdDef);
' #txt
Do0 f52 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
Do0 f54 responseActionDecl 'htmlDialogDemos.Data out;
' #txt
Do0 f54 responseMappingAction 'out=in;
' #txt
...
type.name=
' #txt
Do0 f62 showInStartList 1 #txt
Do0 f62 taskAndCaseSetupAction 'import ch.ivyteam.ivy.workflow.TaskUpdateDefinition;
ch.ivyteam.ivy.workflow.TaskUpdateDefinition taskUpdDef = new ch.ivyteam.ivy.workflow.TaskUpdateDefinition();
import ch.ivyteam.ivy.request.impl.DefaultCalendarProxy;
DefaultCalendarProxy calendarProxy = ivy.cal as DefaultCalendarProxy;
taskUpdDef.setPriority(ch.ivyteam.ivy.workflow.WorkflowPriority.valueOf(2));
...
Do0 f63 responseActionDecl 'htmlDialogDemos.Data out;
' #txt
Do0 f63 responseMappingAction 'out=in;
' #txt
Do0 f63 windowConfiguration '* ' #txt
...
Do0 f47 mainOut f50 tail #connect
Do0 f50 head f49 mainIn #connect
Do0 f49 mainOut f51 tail #connect
Do0 f51 head f48 mainIn #connect
Do0 f52 mainOut f55 tail #connect
...
Do0 f62 mainOut f65 tail #connect
