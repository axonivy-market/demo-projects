...
private RTabbedPane getTabbedPane() {
	if (TabbedPane == null) {
		...
		TabbedPane.addTab("<%=ivy.cms.co(\"/basicwfui/labels/task/info\")%>", null, getTaskInfoDetailsPanel(), null);
		TabbedPane.addTab("<%=ivy.cms.co(\"/basicwfui/labels/info/taskCustomFields\")%>", null, getTaskInfoCustomFieldsPanel(), null);
		TabbedPane.addTab("<%=ivy.cms.co(\"/basicwfui/labels/info/caseCategorization\")%>", null, getCaseInfoCategorizationPanel(), null);
		TabbedPane.addTab("<%=ivy.cms.co(\"/basicwfui/labels/info/caseBusinessDetails\")%>", null, getCaseInfoBusinessDetailsPanel(), null);
		TabbedPane.addTab("<%=ivy.cms.co(\"/basicwfui/labels/info/caseCustomFields\")%>", null, getCaseInfoCustomFieldsPanel(), null);
	}
	return TabbedPane;
}
...
private RLabel getLabel() {
	if (Label == null) {
		Label = new RLabel();
		Label.setIconUri("<%=ivy.cms.cr(\"/basicwfui/images/task_48\")%>");
		Label.setStyle("basicwfui_caption");
		Label.setText("Task Info");
		Label.setName("Label");
	}
	return Label;
}
