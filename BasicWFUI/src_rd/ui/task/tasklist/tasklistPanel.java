...
private RTable getTable() {
	if (Table == null) {
		...
		Table.setModelConfiguration("{/showTableheader true /autoTableheader false /showtooltip false /showIcons false /emptyTableText \"---\"/version \"3.0\"/columns {{/result \"result=entry.getIdentifier()\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"\\\"Id\\\"\"/field \"\"/editable \"\"/condition \"\"/cellWidget \"\"}{/result \"result=entry.getName()\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"\\\"Name\\\"\"/field \"\"/editable \"\"/condition \"\"/columnWidth \"300\"/cellWidget \"\"}{/result \"result=entry.getPriority()\"/version \"3.0\"/tooltip \"\"/icon \"result=ivy.cms.cr(\\\"/icons/prio/\\\"+entry.getPriority())\"/header \"\\\"Prio\\\"\"/field \"\"/editable \"\"/condition \"\"/cellWidget \"\"}{/result \"result=entry.getStartTimestamp()\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"\\\"vom\\\"\"/field \"\"/editable \"\"/condition \"\"/cellWidget \"\"}{/result \"result=entry.getActivatorName()\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"\\\"Rolle/Bearbeiter\\\"\"/field \"\"/editable \"\"/condition \"\"/cellWidget \"\"}{/result \"result=entry.getState()\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"\\\"Status\\\"\"/field \"\"/editable \"\"/condition \"\"/cellWidget \"\"}}}");
...
private RButton getButton() {
	if (Button == null) {
		...
		Button.setText("<%=ivy.cms.co(\"/basicwfui/labels/common/closeTab\")%>");
...
private RLabel getCaptionLabel() {
	if (captionLabel == null) {
		...
		captionLabel.setText("<%=ivy.cms.co(\"/basicwfui/labels/main/tasklist\")%>");
...
private RButton getResumeButton() {
	if (resumeButton == null) {
		...
		resumeButton.setText("<%=ivy.cms.co(\"/basicwfui/labels/task/resume\")%>");
		resumeButton.setIconUri("<%=ivy.cms.cr(\"/basicwfui/images/tasklist\")%>");
...
private RMenuItem getResumeMenuItem() {
	if (resumeMenuItem == null) {
		...
		resumeMenuItem.setText("<%=ivy.cms.co(\"/basicwfui/labels/task/resume\")%>");
		resumeMenuItem.setIconUri("<%=ivy.cms.cr(\"/basicwfui/images/tasklist\")%>");
...
private RHyperlink getHyperlink() {
	if (Hyperlink == null) {
		...
		Hyperlink.setToolTipText("<%=ivy.cms.co(\"/basicwfui/labels/task/refresh\")%>");
		Hyperlink.setStyleProperties("{/anchor \"CENTER\"}");
		Hyperlink.setIconUri("<%=ivy.cms.cr(\"/basicwfui/images/tasklist_48\")%>");
	}
	return Hyperlink;
}
...
private RButton getTaskdetailsButton() {
	if (taskdetailsButton == null) {
		...
		taskdetailsButton.setIconUri("<%=ivy.cms.cr(\"/basicwfui/images/details\")%>");
		taskdetailsButton.setText("<%=ivy.cms.co(\"/basicwfui/labels/task/info\")%>");
...
private RButton getTaskNotesButton() {
	if (taskNotesButton == null) {
		...
		taskNotesButton.setText("<%=ivy.cms.co(\"/basicwfui/labels/task/notes\")%> (0)");
		taskNotesButton.setIconUri("<%=ivy.cms.cr(\"/basicwfui/images/notes\")%>");
...
private RButton getResetButton() {
	if (resetButton == null) {
		...
		resetButton.setIconUri("<%=ivy.cms.cr(\"/basicwfui/images/reset\")%>");
		resetButton.setText("<%=ivy.cms.co(\"/basicwfui/labels/task/reset\")%>");
	}
	return resetButton;
}
