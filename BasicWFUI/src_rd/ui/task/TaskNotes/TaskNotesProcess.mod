[Ivy]
[>Created: Mon Feb 22 17:18:42 CET 2010]
...
Cs0 f45 expr in #txt
Cs0 f45 outCond 'panel.taskNotesTable.getSelectedListEntry() != null ' #txt
...
(panel.noteDetailsEditGridBagLayoutPane.getBorder() as ULCTitledBorder).setTitle(
	ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/note/noteDetails"));
	
(panel.taskNotesScrollPane.getBorder() as ULCTitledBorder).setTitle(
	ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/task/taskNotes"));' #txt
...
>Proto Cs0 .rdData2UIAction 'panel.footerLabel.text=(in.#taskNotes == null? 
	"": 
	ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/common/found") + " " + in.taskNotes.size() + " " + ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/note/note"));
