...
private RButton getAddNoteButton() {
	if (addNoteButton == null) {
		...
		addNoteButton.setIconUri("<%=ivy.cms.cr(\"/ch/ivyteam/ivy/basicwfui/images/addNote\")%>");
		addNoteButton.setToolTipText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/notes/addNote\")%>");
...
private RButton getDeleteNoteButton() {
	if (deleteNoteButton == null) {
		...
		deleteNoteButton.setIconUri("<%=ivy.cms.cr(\"/ch/ivyteam/ivy/basicwfui/images/deleteNote\")%>");
		deleteNoteButton.setToolTipText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/notes/deleteNote\")%>");
...
private RButton getOkButton() {
	if (okButton == null) {
		...
		okButton.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/notes/ok\")%>");
...
private RButton getCancelButton() {
	if (cancelButton == null) {
		...
		cancelButton.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/notes/cancel\")%>");
...
private RLabel getMessageLabel() {
	if (messageLabel == null) {
		...
		messageLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/notes/noteText\")%>");
	}
	return messageLabel;
}
...
private RScrollPane getTaskNotesScrollPane() {
	if (taskNotesScrollPane == null) {
		...
		taskNotesScrollPane.setBorder(BorderFactory.createTitledBorder(null, " ", ULCTitledBorder.DEFAULT_JUSTIFICATION, ULCTitledBorder.DEFAULT_POSITION, new Font("Tahoma", Font.PLAIN, 11), new Color(23, 64, 140)));
...
private RTable getTaskNotesTable() {
	if (taskNotesTable == null) {
		...
		taskNotesTable.setModelConfiguration("{/showTableheader true /autoTableheader false /showtooltip true /showIcons false /version \"3.0\"/emptyTableText \"\"/columns {{/result \"result=entry.value.getIdentifier()\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/basicwfui/labels/notes/noteId\\\")\"/field \"\"/columnWidth \"50\"}{/result \"result=(entry as Tree).info ==\\\"task\\\" ? \\r\\nivy.cms.co(\\\"/ch/ivyteam/ivy/basicwfui/labels/notes/onTask\\\") :\\r\\nivy.cms.co(\\\"/ch/ivyteam/ivy/basicwfui/labels/notes/onCase\\\")\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/basicwfui/labels/notes/noteVisibility\\\")\"/field \"\"/editable \"\"/condition \"\"/columnWidth \"80\"/cellWidget \"\"}{/result \"result=entry.value.getMessage()\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/basicwfui/labels/notes/noteText\\\")\"/field \"\"/columnWidth \"400\"}{/result \"result=entry.value.getWritterName()\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/basicwfui/labels/notes/noteWritter\\\")\"/field \"\"/columnWidth \"50\"}{/result \"result=(entry.value.getCreationTimestamp() as DateTime).format()\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/basicwfui/labels/notes/noteCreationTimestamp\\\")\"/field \"\"/columnWidth \"120\"}}}");
...
private RLabel getNoteIdLabel() {
	if (noteIdLabel == null) {
		...
		noteIdLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/notes/noteId\")%>");
	}
	return noteIdLabel;
}
...
private RLabel getNoteCreationTimestampLabel() {
	if (noteCreationTimestampLabel == null) {
		...
		noteCreationTimestampLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/notes/noteCreationTimestamp\")%>");
	}
...
private RLabel getNoteWritterLabel() {
	if (noteWritterLabel == null) {
		...
		noteWritterLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/notes/noteWritter\")%>");
	}
...
private RGridBagLayoutPane getNoteDetailsEditGridBagLayoutPane() {
	if (noteDetailsEditGridBagLayoutPane == null) {
		...
		noteDetailsEditGridBagLayoutPane.setForeground(Color.darkGray);
		noteDetailsEditGridBagLayoutPane.setBorder(BorderFactory.createTitledBorder(null, " ", ULCTitledBorder.DEFAULT_JUSTIFICATION, ULCTitledBorder.DEFAULT_POSITION, new Font("Tahoma", Font.PLAIN, 11), new Color(23, 64, 140)));
...
private RRadioButton getTaskNoteRadioButton() {
	if (taskNoteRadioButton == null) {
		...
		taskNoteRadioButton.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/notes/visibleOnTask\")%>");
...
private RRadioButton getCaseNoteRadioButton() {
	if (caseNoteRadioButton == null) {
		...
		caseNoteRadioButton.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/notes/visibleOnCase\")%>");
	}
...
private RLabel getVisibilityLabel() {
	if (visibilityLabel == null) {
		...
		visibilityLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/notes/noteVisibility\")%>");
	}
