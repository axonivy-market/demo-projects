 ...
 * @since <%=date%>
 */
public class TaskInfoCustomFieldsPanel extends RichDialogGridBagPanel 
...
private RTextField customTimestampField5TextField = null;
   ...
   */
  public TaskInfoCustomFieldsPanel()
  {
    super();
    initialize();
  }
...
private RLabel getCustomVarcharField1Label() {
	if (customVarcharField1Label == null) {
		...
		customVarcharField1Label.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/task/customFields/customVarcharField\")%> 1");
...
private RLabel getCustomVarcharFiel2Label() {
	if (customVarcharFiel2Label == null) {
		...
		customVarcharFiel2Label.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/task/customFields/customVarcharField\")%> 2");
...
private RLabel getCustomVarcharFiel3Label() {
	if (customVarcharFiel3Label == null) {
		...
		customVarcharFiel3Label.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/task/customFields/customVarcharField\")%> 3");
...
private RLabel getCustomVarcharField4Label() {
	if (customVarcharField4Label == null) {
		...
		customVarcharField4Label.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/task/customFields/customVarcharField\")%> 4");
...
private RLabel getCustomVarcharField5Label() {
	if (customVarcharField5Label == null) {
		...
		customVarcharField5Label.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/task/customFields/customVarcharField\")%> 5");
...
private RLabel getCustomDecimalField1Label() {
	if (customDecimalField1Label == null) {
		...
		customDecimalField1Label.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/task/customFields/customDecimalField\")%> 1");
...
private RLabel getCustomDecimalField2Label() {
	if (customDecimalField2Label == null) {
		...
		customDecimalField2Label.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/task/customFields/customDecimalField\")%> 2");
...
private RLabel getCustomDecimalField3Label() {
	if (customDecimalField3Label == null) {
		...
		customDecimalField3Label.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/task/customFields/customDecimalField\")%> 3");
...
private RLabel getCustomDecimalField4Label() {
	if (customDecimalField4Label == null) {
		...
		customDecimalField4Label.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/task/customFields/customDecimalField\")%> 4");
...
private RLabel getCustomDecimalField5Label() {
	if (customDecimalField5Label == null) {
		...
		customDecimalField5Label.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/task/customFields/customDecimalField\")%> 5");
...
private RLabel getCustomTimestampField1Label() {
	if (customTimestampField1Label == null) {
		...
		customTimestampField1Label.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/task/customFields/customTimestampField\")%> 1");
...
private RLabel getCustomTimestampField2Label() {
	if (customTimestampField2Label == null) {
		...
		customTimestampField2Label.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/task/customFields/customTimestampField\")%> 2");
...
private RLabel getCustomTimestampField3Label() {
	if (customTimestampField3Label == null) {
		...
		customTimestampField3Label.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/task/customFields/customTimestampField\")%> 3");
...
private RLabel getCustomTimestampField4Label() {
	if (customTimestampField4Label == null) {
		...
		customTimestampField4Label.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/task/customFields/customTimestampField\")%> 4");
...
private RLabel getCustomTimestampField5Label() {
	if (customTimestampField5Label == null) {
		...
		customTimestampField5Label.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/task/customFields/customTimestampField\")%> 5");
