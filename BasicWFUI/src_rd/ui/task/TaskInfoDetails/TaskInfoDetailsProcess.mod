...
(panel.responsibleRoleUserGridBagLayoutPane.getBorder() as ULCTitledBorder).setTitle(
	ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/task/taskActivator"));
	
(panel.entryInTaskListGridBagLayoutPane.getBorder() as ULCTitledBorder).setTitle(
	ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/task/taskDetails")
);

(panel.taskStageGridBagLayoutPane.getBorder() as ULCTitledBorder).setTitle(
	ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/task/taskKindName")
);


(panel.businessMilestoneGridBagLayoutPane.getBorder() as ULCTitledBorder).setTitle(
	ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/task/taskMilestone")
);

(panel.processingDelayGridBagLayoutPane.getBorder() as ULCTitledBorder).setTitle(
	ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/task/taskExpiryTimestamp")
);

(panel.blockingDelayGridBagLayoutPane.getBorder() as ULCTitledBorder).setTitle(
	ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/task/taskBlockedUntilTimestamp")
);' #txt
...
panel.taskActivatorLabel.iconUri=(in.#task.#activator is initialized? (in.task.activator.isUser()? "/ch/ivyteam/ivy/basicwfui/images/security/user16": "/ch/ivyteam/ivy/basicwfui/images/security/role16"): "");
...
panel.taskPriorityIconLabel.iconUri=(in.#task is initialized && in.task.getState() is initialized? "/ch/ivyteam/ivy/basicwfui/images/task/taskPriority" + in.task.getPriority().intValue() + "_16": "");
panel.taskPriorityIconLabel.toolTipText=(in.#task is initialized? ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/common/priority") + in.task.getPriority().toString(): "n/a");
...
panel.taskStateIconLabel.iconUri=(in.#task is initialized? "/ch/ivyteam/ivy/basicwfui/images/task/taskState" + in.task.getState() + "16": "");
