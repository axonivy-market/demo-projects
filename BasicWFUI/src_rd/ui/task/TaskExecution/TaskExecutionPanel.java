...
private RButton getResumeButton() {
	if (resumeButton == null) {
		...
		resumeButton.setText("<%=ivy.cms.co(\"/basicwfui/labels/task/details\")%><%=ivy.cms.co(\"/basicwfui/labels/task/info\")%>");
		resumeButton.setIconUri("<%=ivy.cms.cr(\"/basicwfui/images/details\")%>");
...
private RHyperlink getHyperlink() {
	if (Hyperlink == null) {
		...
		Hyperlink.setIconUri("<%=ivy.cms.cr(\"/basicwfui/images/task_48\")%>");
...
private RButton getParkButton() {
	if (parkButton == null) {
		...
		parkButton.setIconUri("<%=ivy.cms.cr(\"/basicwfui/images/park\")%>");
		parkButton.setText("<%=ivy.cms.co(\"/basicwfui/labels/task/park\")%>");
	}
	return parkButton;
}
...
private RButton getResetButton1() {
	if (resetButton1 == null) {
		...
		resetButton1.setIconUri("<%=ivy.cms.cr(\"/basicwfui/images/reset\")%>");
		resetButton1.setText("<%=ivy.cms.co(\"/basicwfui/labels/task/reset\")%>");
...
private RButton getNotesButton() {
	if (notesButton == null) {
		...
		notesButton.setText("<%=ivy.cms.co(\"/basicwfui/labels/task/notes\")%>");
		notesButton.setIconUri("<%=ivy.cms.cr(\"/basicwfui/images/notes\")%>");
