[Ivy]
[>Created: Wed Dec 23 17:29:33 CET 2009]
...
' #txt
Ps0 f3 actionCode 'out.starts = ivy.session.getStartableProcessStarts();' #txt
...
' #txt
Ps0 f10 actionDecl 'ui.process.ProcessStartList.ProcessStartListData out;
' #txt
Ps0 f10 actionTable 'out=in;
' #txt
Ps0 f10 actionCode 'import ch.ivyteam.ivy.richdialog.exec.ProcessStartConfiguration;
...
Ps0 f10 type ui.process.ProcessStartList.ProcessStartListData #txt
Ps0 f10 86 284 36 24 25 -10 #rect
Ps0 f10 @|RichDialogProcessStepIcon #fIcon
Ps0 f9 expr out #txt
Ps0 f9 104 308 104 366 #arcP
...
>Proto Ps0 .rdData2UIAction 'panel.Table.listData=in.starts;
' #txt
