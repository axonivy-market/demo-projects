...
private RLabel getCaptionLabel() {
	if (captionLabel == null) {
		...
		captionLabel.setText("<%=ivy.cms.co(\"/basicwfui/labels/main/processstartlist\")%>");
...
private RMenuItem getStartProcessMenuItem() {
	if (startProcessMenuItem == null) {
		...
		startProcessMenuItem.setText("<%=ivy.cms.co(\"/basicwfui/labels/process/startProcess\")%>");
		startProcessMenuItem.setIconUri("<%=ivy.cms.cr(\"/basicwfui/images/processstart\")%>");
...
private RButton getStartButton() {
	if (startButton == null) {
		...
		startButton.setText("<%=ivy.cms.co(\"/basicwfui/labels/process/startProcess\")%>");
		startButton.setStyle("basicwfui_toolbarbutton");
		startButton.setIconUri("<%=ivy.cms.cr(\"/basicwfui/images/processstart\")%>");
	}
	return startButton;
}
...
private RHyperlink getHyperlink() {
	if (Hyperlink == null) {
		...
		Hyperlink.setToolTipText("<%=ivy.cms.co(\"/basicwfui/labels/process/refresh\")%>");
		Hyperlink.setIconUri("<%=ivy.cms.cr(\"/basicwfui/images/processstart_48\")%>");
	}
	return Hyperlink;
}
