[Ivy]
[>Created: Wed Dec 30 16:02:50 CET 2009]
125E013BF7895A35 3.13 #module
...
Ts0 f0 type ui.cases.CaseInfoCategorization.CaseInfoCategorizationData #txt
...
Ts0 f4 type ui.cases.CaseInfoCategorization.CaseInfoCategorizationData #txt
Ts0 f4 99 355 26 26 14 0 #rect
Ts0 f4 @|RichDialogProcessEndIcon #fIcon
Ts0 f1 guid 1194CDB08E523727 #txt
Ts0 f1 type ui.cases.CaseInfoCategorization.CaseInfoCategorizationData #txt
...
Ts0 f5 type ui.cases.CaseInfoCategorization.CaseInfoCategorizationData #txt
...
Ts0 f7 type ui.cases.CaseInfoCategorization.CaseInfoCategorizationData #txt
...
' #txt
Ts0 f2 actionDecl 'ui.cases.CaseInfoCategorization.CaseInfoCategorizationData out;
' #txt
Ts0 f2 actionTable 'out=in;
' #txt
Ts0 f2 type ui.cases.CaseInfoCategorization.CaseInfoCategorizationData #txt
...
Ts0 f9 type ui.cases.CaseInfoCategorization.CaseInfoCategorizationData #txt
...
Ts0 f13 type ui.cases.CaseInfoCategorization.CaseInfoCategorizationData #txt
Ts0 f13 actionDecl 'ui.cases.CaseInfoCategorization.CaseInfoCategorizationData out;
' #txt
...
' #txt
Ts0 f14 actionDecl 'ui.cases.CaseInfoCategorization.CaseInfoCategorizationData out;
' #txt
...
(panel.caseGridBagLayoutPane.getBorder() as ULCTitledBorder).setTitle(
	ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/case/case"));
	
(panel.processCategoryGridBagLayoutPane.getBorder() as ULCTitledBorder).setTitle(
	ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/case/caseProcessCategoryName")
);


(panel.caseProcessGridBagLayoutPane.getBorder() as ULCTitledBorder).setTitle(
	ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/case/caseProcessName")
);

(panel.caseTypeGridBagLayoutPane.getBorder() as ULCTitledBorder).setTitle(
	ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/case/caseTypeName")
);

(panel.caseSubTypeGridBagLayoutPane.getBorder() as ULCTitledBorder).setTitle(
	ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/case/caseSubTypeName")
);
' #txt
Ts0 f14 type ui.cases.CaseInfoCategorization.CaseInfoCategorizationData #txt
...
' #txt
Ts0 f17 actionDecl 'ui.cases.CaseInfoCategorization.CaseInfoCategorizationData out;
' #txt
...
Ts0 f17 type ui.cases.CaseInfoCategorization.CaseInfoCategorizationData #txt
...
>Proto Ts0 .type ui.cases.CaseInfoCategorization.CaseInfoCategorizationData #txt
...
panel.caseIdIconLabel.toolTipText=(in.#fCase is initialized? ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/case/caseId") + ": " + in.fCase.getIdentifier().toString(): "n/a");
...
panel.casePriorityIconLabel.iconUri=(in.#fCase is initialized? "/ch/ivyteam/ivy/basicwfui/images/case/casePriority" + in.fCase.getPriority().intValue() + "_16": "");
panel.casePriorityIconLabel.toolTipText=(in.#fCase is initialized? ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/common/priority") + in.fCase.getPriority().toString(): "n/a");
