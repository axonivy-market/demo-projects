package ui.cases.CaseInfoCategorization;
 ...
 * @since <%=date%>
 */
public class CaseInfoCategorizationPanel extends RichDialogGridBagPanel 
...
/**
   ...
   */
  public CaseInfoCategorizationPanel()
  {
    super();
    initialize();
  }
...
private RLabel getCaseProcessNameLabel() {
	if (caseProcessNameLabel == null) {
		...
		caseProcessNameLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/case/caseProcessName\")%> <%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/common/name\")%>");
...
private RLabel getCaseProcessCategoryCodeLabel() {
	if (caseProcessCategoryCodeLabel == null) {
		...
		caseProcessCategoryCodeLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/case/caseProcessCategoryName\")%> <%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/common/code\")%>");
...
private RLabel getCaseTypeCodeLabel() {
	if (caseTypeCodeLabel == null) {
		...
		caseTypeCodeLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/case/caseTypeName\")%> <%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/common/code\")%>");
...
private RLabel getCaseSubTypeNameLabel() {
	if (caseSubTypeNameLabel == null) {
		...
		caseSubTypeNameLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/case/caseSubTypeName\")%> <%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/common/name\")%>");
...
private RLabel getCaseNameLabel() {
	if (caseNameLabel == null) {
		...
		caseNameLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/case/caseName\")%>");
...
private RLabel getCaseIdIconLabel() {
	if (caseIdIconLabel == null) {
		...
		caseIdIconLabel.setIconUri("<%=ivy.cms.cr(\"/ch/ivyteam/ivy/basicwfui/images/case/CASE_ID16\")%>");
...
private RLabel getCaseDescriptionLabel() {
	if (caseDescriptionLabel == null) {
		...
		caseDescriptionLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/case/caseDescription\")%>");
	}
...
private RLabel getCaseProcessCategoryNameLabel() {
	if (caseProcessCategoryNameLabel == null) {
		...
		caseProcessCategoryNameLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/case/caseProcessCategoryName\")%> <%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/common/name\")%>");
...
private RLabel getCaseProcessCodeLabel() {
	if (caseProcessCodeLabel == null) {
		...
		caseProcessCodeLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/case/caseProcessName\")%> <%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/common/code\")%>");
	}
...
private RLabel getCaseTypeNameLabel() {
	if (caseTypeNameLabel == null) {
		...
		caseTypeNameLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/case/caseTypeName\")%> <%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/common/name\")%>");
	}
...
private RLabel getCaseSubTypeCodeLabel() {
	if (caseSubTypeCodeLabel == null) {
		...
		caseSubTypeCodeLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/case/caseSubTypeName\")%> <%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/common/code\")%>");
	}
...
private RLabel getCaseProcessCategoryLabel() {
	if (caseProcessCategoryLabel == null) {
		...
		caseProcessCategoryLabel.setIconUri("<%=ivy.cms.cr(\"/ch/ivyteam/ivy/basicwfui/images/case/PROCESS_CATEGORY_CODE16\")%>");
...
private RLabel getCaseProcessLabel() {
	if (caseProcessLabel == null) {
		...
		caseProcessLabel.setIconUri("<%=ivy.cms.cr(\"/ch/ivyteam/ivy/basicwfui/images/case/PROCESS_CODE16\")%>");
...
private RLabel getCaseTypeLabel() {
	if (caseTypeLabel == null) {
		...
		caseTypeLabel.setIconUri("<%=ivy.cms.cr(\"/ch/ivyteam/ivy/basicwfui/images/case/TYPE_CODE16\")%>");
...
private RLabel getCaseSubTypeLabel() {
	if (caseSubTypeLabel == null) {
		...
		caseSubTypeLabel.setIconUri("<%=ivy.cms.cr(\"/ch/ivyteam/ivy/basicwfui/images/case/SUB_TYPE_CODE16\")%>");
...
private RLabel getCaseStartLabel() {
	if (caseStartLabel == null) {
		...
		caseStartLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/case/caseStartTimestamp\")%>");
...
private RLabel getCaseStateLabel() {
	if (caseStateLabel == null) {
		...
		caseStateLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/case/caseState\")%>");
	}
...
private RLabel getCasePriorityLabel() {
	if (casePriorityLabel == null) {
		...
		casePriorityLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/case/casePriority\")%>");
	}
...
private RLabel getCaseIdLabel() {
	if (caseIdLabel == null) {
		...
		caseIdLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/basicwfui/labels/case/businessMainContact/id\")%>");
	}
	return caseIdLabel;
}
