...
Cs0 f0 type ui.cases.CaseInfoCustomFields.CaseInfoCustomFieldsData #txt
...
Cs0 f1 type ui.cases.CaseInfoCustomFields.CaseInfoCustomFieldsData #txt
...
Cs0 f2 type ui.cases.CaseInfoCustomFields.CaseInfoCustomFieldsData #txt
...
Cs0 f8 type ui.cases.CaseInfoCustomFields.CaseInfoCustomFieldsData #txt
...
Cs0 f9 type ui.cases.CaseInfoCustomFields.CaseInfoCustomFieldsData #txt
...
Cs0 f7 actionDecl 'ui.cases.CaseInfoCustomFields.CaseInfoCustomFieldsData out;
' #txt
Cs0 f7 actionTable 'out=in;
' #txt
Cs0 f7 type ui.cases.CaseInfoCustomFields.CaseInfoCustomFieldsData #txt
...
Cs0 f11 type ui.cases.CaseInfoCustomFields.CaseInfoCustomFieldsData #txt
...
Cs0 f13 actionDecl 'ui.cases.CaseInfoCustomFields.CaseInfoCustomFieldsData out;
' #txt
...
(panel.customVarcharFieldsGridBagLayoutPane.getBorder() as ULCTitledBorder).setTitle(
	ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/case/customFields/customVarcharFields"));
	
(panel.customDecimalFieldsGridBagLayoutPane.getBorder() as ULCTitledBorder).setTitle(
	ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/case/customFields/customDecimalFields"));
	
(panel.customTimestampFieldsGridBagLayoutPane.getBorder() as ULCTitledBorder).setTitle(
	ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/case/customFields/customTimestampFields"));' #txt
Cs0 f13 type ui.cases.CaseInfoCustomFields.CaseInfoCustomFieldsData #txt
...
Cs0 f14 type ui.cases.CaseInfoCustomFields.CaseInfoCustomFieldsData #txt
Cs0 f14 actionDecl 'ui.cases.CaseInfoCustomFields.CaseInfoCustomFieldsData out;
' #txt
...
>Proto Cs0 .type ui.cases.CaseInfoCustomFields.CaseInfoCustomFieldsData #txt
