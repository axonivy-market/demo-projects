...
private RLabel getBusinessMainContactNameLabel() {
	if (businessMainContactNameLabel == null) {
		...
		businessMainContactNameLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/workflow/ui/case/businessMainContact/plainStrings/name\")%>");
	}
...
private RLabel getBusinessMainContactTypeLabel() {
	if (businessMainContactTypeLabel == null) {
		...
		businessMainContactTypeLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/workflow/ui/case/businessMainContact/plainStrings/type\")%>");
	}
...
private RLabel getBusinessMainContactIdLabel() {
	if (businessMainContactIdLabel == null) {
		...
		businessMainContactIdLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/workflow/ui/case/businessMainContact/plainStrings/id\")%>");
	}
...
private RLabel getBusinessMainContactLabel() {
	if (businessMainContactLabel == null) {
		...
		businessMainContactLabel.setText("");
	}
...
private RGridBagLayoutPane getCorrespondentContactGridBagLayoutPane() {
	if (correspondentContactGridBagLayoutPane == null) {
		...
		aFiller.setStyleProperties("{/usePreferredSizeAsExactSize \"true\"/preferredSizeWidth \"16\"}");
		...
		correspondentContactGridBagLayoutPane.add(aFiller, new com.ulcjava.base.application.GridBagConstraints(0, 0, 1, 1, -1, -1, com.ulcjava.base.application.GridBagConstraints.CENTER, com.ulcjava.base.application.GridBagConstraints.NONE, new com.ulcjava.base.application.util.Insets(0,0,0,0), 0, 0));
...
private RGridBagLayoutPane getBusinessObjectGridBagLayoutPane() {
	if (businessObjectGridBagLayoutPane == null) {
		...
		aFiller1.setStyleProperties("{/usePreferredSizeAsExactSize \"true\"/preferredSizeWidth \"16\"}");
		...
		businessObjectGridBagLayoutPane.add(aFiller1, new com.ulcjava.base.application.GridBagConstraints(0, 0, 1, 1, -1, -1, com.ulcjava.base.application.GridBagConstraints.CENTER, com.ulcjava.base.application.GridBagConstraints.NONE, new com.ulcjava.base.application.util.Insets(0,0,0,0), 0, 0));
...
private RLabel getBusinessObjectCodeLabel() {
	if (businessObjectCodeLabel == null) {
		...
		businessObjectCodeLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/workflow/ui/case/businessObject/plainStrings/code\")%>");
...
private RLabel getBusinessObjectNameLabel() {
	if (businessObjectNameLabel == null) {
		...
		businessObjectNameLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/workflow/ui/case/businessObject/plainStrings/name\")%>");
...
private RGridBagLayoutPane getOtherGridBagLayoutPane() {
	if (otherGridBagLayoutPane == null) {
		...
		otherGridBagLayoutPane.add(getDateTimeLabel(), new com.ulcjava.base.application.GridBagConstraints(0, 0, 1, 1, -1, -1, com.ulcjava.base.application.GridBagConstraints.CENTER, com.ulcjava.base.application.GridBagConstraints.NONE, new com.ulcjava.base.application.util.Insets(0,0,0,0), 0, 0));
		...
		otherGridBagLayoutPane.add(getDateTimeMilestoneIconLabel(), new com.ulcjava.base.application.GridBagConstraints(0, 1, 1, 1, -1, -1, com.ulcjava.base.application.GridBagConstraints.CENTER, com.ulcjava.base.application.GridBagConstraints.NONE, new com.ulcjava.base.application.util.Insets(0,0,0,0), 0, 0));
		...
		otherGridBagLayoutPane.add(getBusinessCreatorLabel(), new com.ulcjava.base.application.GridBagConstraints(0, 3, 1, 1, -1, -1, com.ulcjava.base.application.GridBagConstraints.CENTER, com.ulcjava.base.application.GridBagConstraints.NONE, new com.ulcjava.base.application.util.Insets(0,0,0,0), 0, 0));
	}
...
private RLabel getDateTimeStartLabel() {
	if (dateTimeStartLabel == null) {
		...
		dateTimeStartLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/workflow/ui/case/businessStartTimestamp/plainStrings/start\")%>");
...
private RLabel getDateTimeMilestoneLabel() {
	if (dateTimeMilestoneLabel == null) {
		...
		dateTimeMilestoneLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/workflow/ui/case/businessStartTimestamp/plainStrings/milestone\")%>");
...
/**
 * This method initializes dateTimeLabel	
 * 	
 * @return ch.ivyteam.ivy.richdialog.widgets.components.RLabel	
 */
private RLabel getDateTimeLabel() {
	if (dateTimeLabel == null) {
		dateTimeLabel = new RLabel();
		dateTimeLabel.setText("");
		dateTimeLabel.setIconUri("<%=ivy.cms.cr(\"/ch/ivyteam/ivy/workflow/ui/case/images/BUSINESS_START_TIMESTAMP16\")%>");
...
private RLabel getPriorityLabel() {
	if (priorityLabel == null) {
		...
		priorityLabel.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/workflow/ui/case/plainStrings/casePriority\")%>");
...
private RLabel getBusinessCreatorLabel() {
	if (businessCreatorLabel == null) {
		...
		businessCreatorLabel.setIconUri("<%=ivy.cms.cr(\"/ch/ivyteam/ivy/workflow/ui/case/images/BUSINESS_CREATOR_USER16\")%>");
		businessCreatorLabel.setText("");
	}
	return businessCreatorLabel;
}

/**
 * This method initializes dateTimeMilestoneIconLabel	
 * 	
 * @return ch.ivyteam.ivy.richdialog.widgets.components.RLabel	
 */
private RLabel getDateTimeMilestoneIconLabel() {
	if (dateTimeMilestoneIconLabel == null) {
		dateTimeMilestoneIconLabel = new RLabel();
		dateTimeMilestoneIconLabel.setName("dateTimeMilestoneIconLabel");
		dateTimeMilestoneIconLabel.setIconUri("<%=ivy.cms.cr(\"/ch/ivyteam/ivy/workflow/ui/case/images/BUSINESS_START_TIMESTAMP16\")%>");
		dateTimeMilestoneIconLabel.setName("dateTimeMilestoneIconLabel");
		dateTimeMilestoneIconLabel.setText("");
	}
	return dateTimeMilestoneIconLabel;
}
