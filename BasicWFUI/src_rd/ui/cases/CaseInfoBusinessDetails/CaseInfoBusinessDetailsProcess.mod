...
(panel.caseBusinessDetailsGridBagLayoutPane.getBorder() as ULCTitledBorder).setTitle(
	ivy.cms.co("/ch/ivyteam/ivy/workflow/ui/case/businessMainContact/plainStrings/businessMainContact"));
...
(panel.correspondentContactGridBagLayoutPane.getBorder() as ULCTitledBorder).setTitle(
		ivy.cms.co("/ch/ivyteam/ivy/workflow/ui/case/correspondentContact/plainStrings/correspondentContact"));
		
(panel.businessObjectGridBagLayoutPane.getBorder() as ULCTitledBorder).setTitle(
	ivy.cms.co("/ch/ivyteam/ivy/workflow/ui/case/businessObject/plainStrings/businessObject"));		
...
panel.businessMainContactLabel.visible=(in.#fCase.#businessMainContactType is initialized);
...
panel.dateTimeLabel.visible=(in.#fCase.#businessStartTimestamp is initialized);
panel.dateTimeMilestoneIconLabel.visible=(in.#fCase.#businessMilestoneTimestamp is initialized);
