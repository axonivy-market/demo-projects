[Ivy]
[>Created: Thu Dec 31 10:46:36 CET 2009]
...
' #txt
ls0 f8 86 306 28 28 23 -22 #rect
ls0 f8 @|AlternativeIcon #fIcon
ls0 f6 expr out #txt
ls0 f6 100 266 100 306 #arcP
ls0 f9 actionDecl 'ui.basic.login.loginData out;
' #txt
ls0 f9 actionTable 'out=in;
' #txt
ls0 f9 panelTable 'panel.errorLabel.text=ivy.cms.co("/basicwfui/labels/main/loginError");
' #txt
...
' #txt
ls0 f9 214 308 36 24 25 -7 #rect
ls0 f9 @|RichDialogProcessStepIcon #fIcon
ls0 f10 expr in #txt
ls0 f10 114 320 214 320 #arcP
...
{
	panel.loginInfoLabel.text = ivy.cms.co("/basicwfui/labels/main/wfuser_info")+" "+ivy.session.getSessionUserName();	
}
else
{
...
' #txt
ls0 f17 actionCode 'ivy.session.logoutSessionUser();
...
' #txt
ls0 f17 374 308 36 24 20 -2 #rect
ls0 f17 @|RichDialogProcessStepIcon #fIcon
ls0 f18 expr out #txt
ls0 f18 392 266 392 308 #arcP
...
' #txt
ls0 f22 82 372 36 24 20 -2 #rect
ls0 f22 @|RichDialogFireEventIcon #fIcon
ls0 f23 expr in #txt
ls0 f23 outCond ivy.session.loginSessionUser(in.name,in.pw) #txt
ls0 f23 100 334 100 372 #arcP
...
' #txt
ls0 f24 374 372 36 24 20 -2 #rect
ls0 f24 @|RichDialogFireEventIcon #fIcon
ls0 f25 expr out #txt
ls0 f25 392 332 392 372 #arcP
ls0 f14 expr out #txt
ls0 f14 392 396 392 438 #arcP
