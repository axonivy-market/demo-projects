...
private RLabel getNameLabel() {
	if (nameLabel == null) {
		...
		nameLabel.setText("<%=ivy.cms.co(\"/basicwfui/labels/main/loginName\")%>");
	}
	return nameLabel;
}
...
private RLabel getPasswordLabel() {
	if (passwordLabel == null) {
		...
		passwordLabel.setText("<%=ivy.cms.co(\"/basicwfui/labels/main/loginPw\")%>");
	}
...
private RLabel getCaptionLabel() {
	if (captionLabel == null) {
		...
		captionLabel.setIconUri("<%=ivy.cms.cr(\"/basicwfui/images/wfuser_48\")%>");
		captionLabel.setStyle("basicwfui_caption");
		captionLabel.setText("<%=ivy.cms.co(\"/basicwfui/labels/main/loginCaption\")%>");
	}
	return captionLabel;
}
...
private RButton getLoginButton() {
	if (loginButton == null) {
		...
		loginButton.setText("<%=ivy.cms.co(\"/basicwfui/labels/main/login\")%>");
...
private RHyperlink getLogoutHyperlink() {
	if (logoutHyperlink == null) {
		...
		logoutHyperlink.setText("> <%=ivy.cms.co(\"/basicwfui/labels/main/logout\")%>");
...
private RButton getCloseButton() {
	if (closeButton == null) {
		...
		closeButton.setText("<%=ivy.cms.co(\"/basicwfui/labels/common/closeTab\")%>");
