[Ivy]
[>Created: Thu Feb 25 14:38:35 CET 2010]
...
ms0 @RichDialogEnd f25 '' #zField
ms0 @RichDialogProcessStart f26 '' #zField
ms0 @RichDialogProcessStep f27 '' #zField
...
ms0 @RichDialogProcessStep f46 '' #zField
...
ms0 f7 panelName <%=ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/main/tasklist")%> #txt
...
ms0 f19 panelName <%=ivy.cms.co("/ch/ivyteam/ivy/basicwfui/labels/main/processstartlist")%> #txt
...
ms0 f25 type ui.basic.main.mainData #txt
ms0 f25 guid 127049585204B49F #txt
ms0 f25 390 206 20 20 13 0 #rect
ms0 f25 @|RichDialogEndIcon #fIcon
ms0 f26 guid 1270495943A76BAB #txt
ms0 f26 type ui.basic.main.mainData #txt
ms0 f26 actionDecl 'ui.basic.main.mainData out;
' #txt
...
' #txt
ms0 f26 390 30 20 20 13 0 #rect
ms0 f26 @|RichDialogProcessStartIcon #fIcon
...
' #txt
ms0 f27 actionDecl 'ui.basic.main.mainData out;
' #txt
ms0 f27 actionTable 'out=in;
' #txt
ms0 f27 actionCode ivy.session.logoutSessionUser(); #txt
ms0 f27 type ui.basic.main.mainData #txt
ms0 f27 382 116 36 24 20 -2 #rect
ms0 f27 @|RichDialogProcessStepIcon #fIcon
ms0 f38 expr out #txt
ms0 f38 400 50 400 116 #arcP
ms0 f39 expr out #txt
ms0 f39 400 140 400 206 #arcP
ms0 f40 guid 127054CF63F19A58 #txt
ms0 f40 type ui.basic.main.mainData #txt
ms0 f40 actionDecl 'ui.basic.main.mainData out;
' #txt
...
<elementInfo>
    <language>
        <name>RD_Event_Close</name>
        <nameStyle>14,5,7,9
</nameStyle>
    </language>
</elementInfo>
' #txt
ms0 f40 638 30 20 20 13 0 #rect
ms0 f40 @|RichDialogProcessStartIcon #fIcon
ms0 f41 type ui.basic.main.mainData #txt
ms0 f41 638 214 20 20 13 0 #rect
ms0 f41 @|RichDialogProcessEndIcon #fIcon
ms0 f43 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>no more panels</name>
        <nameStyle>14,9
</nameStyle>
    </language>
</elementInfo>
' #txt
ms0 f43 type ui.basic.main.mainData #txt
ms0 f43 634 74 28 28 14 0 #rect
ms0 f43 @|AlternativeIcon #fIcon
ms0 f44 expr out #txt
ms0 f44 648 50 648 74 #arcP
ms0 f46 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>close tab</name>
        <nameStyle>9,9
...
' #txt
ms0 f46 actionDecl 'ui.basic.main.mainData out;
' #txt
ms0 f46 actionTable 'out=in;
' #txt
ms0 f46 actionCode 'import ch.ivyteam.ivy.richdialog.exec.panel.IRichDialogPanel;
...
ms0 f46 type ui.basic.main.mainData #txt
ms0 f46 630 148 36 24 20 -2 #rect
ms0 f46 @|RichDialogProcessStepIcon #fIcon
ms0 f42 expr out #txt
ms0 f42 648 172 648 214 #arcP
ms0 f45 expr in #txt
ms0 f45 outCond panel.centerTabbedDisplay.getComponents().size()==0 #txt
ms0 f45 636 90 418 125 #arcP
ms0 f47 expr in #txt
ms0 f47 648 102 648 148 #arcP
...
ms0 f26 mainOut f38 tail #connect
ms0 f38 head f27 mainIn #connect
ms0 f27 mainOut f39 tail #connect
ms0 f39 head f25 mainIn #connect
ms0 f40 mainOut f44 tail #connect
ms0 f44 head f43 in #connect
ms0 f46 mainOut f42 tail #connect
ms0 f42 head f41 mainIn #connect
ms0 f43 out f45 tail #connect
ms0 f45 head f27 mainIn #connect
ms0 f43 out f47 tail #connect
ms0 f47 head f46 mainIn #connect
