...
<form action="<%=ivy.html.ref("LinkA.ivp")%>" method="post">
	<table>
		<tr>
			...
			<td WIDTH="10%"><input type="radio" CHECKED style="border:0;" name="noteFor" value="task">Aufgabe</input></td>
			<td WIDTH="10%"><input type="radio" style="border:0;" name="noteFor" value="case">Fall</input></td>
		</tr>
		<tr>
