  ...
  */
  ...
  private ExecutionResult verifyRequest(BpmClient bpmClient, ExecutionResult previousResult, String role)
  {
    ExecutionResult result = bpmClient.start()
            .task(previousResult.workflow().nextTask().activatorRole(role).get())
  ...
  {
    ExecutionResult result = bpmClient.start()
            .task(previousResult.workflow().nextTask().name().contains("Accept Request:").get())
  ...
  {
    client.start().task(previousResult.workflow().nextTask().system().get())
