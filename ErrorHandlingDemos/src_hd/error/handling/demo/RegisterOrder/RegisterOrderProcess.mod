[Ivy]
[>Created: Tue Jul 28 10:22:23 CEST 2015]
14ECFEF3BADB5A9E 3.17 #module
...
Rs0 f0 type error.handling.demo.RegisterOrder.RegisterOrderData #txt
...
Rs0 f1 type error.handling.demo.RegisterOrder.RegisterOrderData #txt
Rs0 f1 339 51 26 26 0 12 #rect
Rs0 f1 @|RichDialogProcessEndIcon #fIcon
Rs0 f3 guid 14ECFEF3BE4B400F #txt
Rs0 f3 type error.handling.demo.RegisterOrder.RegisterOrderData #txt
Rs0 f3 actionDecl 'error.handling.demo.RegisterOrder.RegisterOrderData out;
' #txt
...
Rs0 f4 type error.handling.demo.RegisterOrder.RegisterOrderData #txt
Rs0 f4 guid 14ECFEF3BE5B1A0E #txt
