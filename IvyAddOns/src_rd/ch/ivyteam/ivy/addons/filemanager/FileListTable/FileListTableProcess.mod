[Ivy]
[>Created: Fri Oct 15 07:10:35 CEST 2010]
125FDB0198DDACE8 3.13.1 #module
...
if(panel.#fileListTable.getSelectedListEntry()!=null && panel.fileListTable.getSelectedListEntry() instanceof DocumentOnServer){
  ...
  doc = panel.fileListTable.selectedListEntry as DocumentOnServer;
	...
	in.selectedDocumentOnServer.filename=doc.filename.trim().trim();
	in.selectedDocumentOnServer.path=doc.path.trim();
	in.selectedDocumentOnServer.fileSize=doc.fileSize;
	
	in.selectedFile=new java.io.File(in.selectedDocumentOnServer.path);
	panel.enablerTextField.setText("selected");

}else{
	panel.enablerTextField.setText("");
}' #txt
Fs0 f35 1494 54 20 20 -25 -31 #rect
...
Fs0 f36 1491 115 26 26 14 0 #rect
Fs0 f36 @|RichDialogProcessEndIcon #fIcon
Fs0 f37 expr out #txt
Fs0 f37 1504 74 1504 115 #arcP
...
try{
	...
	for(DocumentOnServer doc : docs){
		java.io.File file= new java.io.File(doc.path);
		in.selectedFilesList.add(file);
	}
}catch(Throwable t){
	ivy.log.error(t.getMessage(),t);
}

//List<DocumentOnServer> docs=panel.getSelectedDocuments();
' #txt
...
Fs0 f46 1622 54 20 20 -22 -26 #rect
...
Fs0 f47 1619 195 26 26 14 0 #rect
...
' #txt
Fs0 f49 1494 198 20 20 -27 -32 #rect
...
Fs0 f50 1491 283 26 26 14 0 #rect
...
Fs0 f52 1790 46 20 20 -25 -28 #rect
...
Fs0 f57 78 588 36 24 20 -23 #rect
...
Fs0 f64 894 860 36 24 27 -25 #rect
...
Fs0 f75 requestMappingAction 'param.icon="/ch/ivyteam/ivy/addons/icons/question/48";
...
' #txt
Fs0 f75 requestActionCode 'param.question=ivy.cms.co("/ch/ivyteam/ivy/addons/filemanager/fileManagement/messages/question/overwriteExistingFiles")+"\n''"+in.tmpFile.getName()+"''\n";' #txt
...
' #txt
Fs0 f75 windowConfiguration '{/title "<%=in.windowTitle%>"/width 0 /height 0 /centered true /resizable true /maximized false /close_after_last_rd true }' #txt
Fs0 f75 isAsynch false #txt
Fs0 f75 isInnerRd true #txt
Fs0 f75 isDialog true #txt
Fs0 f75 1222 620 36 24 24 -16 #rect
...
' #txt
Fs0 f70 1226 658 28 28 14 0 #rect
Fs0 f70 @|AlternativeIcon #fIcon
Fs0 f71 expr out #txt
Fs0 f71 1240 644 1240 658 #arcP
...
Fs0 f72 1222 716 36 24 20 -2 #rect
...
' #txt
Fs0 f73 1240 686 1240 716 #arcP
...
' #txt
Fs0 f79 1226 672 1227 856 #arcP
Fs0 f79 1 1160 672 #addKink
Fs0 f79 2 1160 856 #addKink
...
' #txt
Fs0 f83 1150 910 20 20 -42 -29 #rect
...
Fs0 f100 1494 390 20 20 -33 -30 #rect
...
Fs0 f101 1491 443 26 26 14 0 #rect
Fs0 f101 @|RichDialogProcessEndIcon #fIcon
Fs0 f102 expr out #txt
Fs0 f102 1504 410 1504 443 #arcP
...
Fs0 f103 1638 574 20 20 -44 -27 #rect
...
' #txt
Fs0 f108 1494 574 20 20 -33 -30 #rect
...
Fs0 f109 1491 627 26 26 14 0 #rect
Fs0 f109 @|RichDialogProcessEndIcon #fIcon
Fs0 f110 expr out #txt
Fs0 f110 1504 594 1504 627 #arcP
...
' #txt
Fs0 f111 1786 186 28 28 14 0 #rect
...
in.selectedFilesList=panel.getSelectedFiles();
for(java.io.File f:in.selectedFilesList){
	ivy.log.debug(f.getPath());
	}
int i=0;
try{
	i=in.fileManagementHandler.deleteFiles(in.selectedFilesList);
}catch(Throwable t){
	in.errorUtil.panelId = in.panelId;
	in.errorUtil.errorOccurred=true;
	in.errorUtil.throwable = t;
...
in.returnedMessage=FileHandler.deleteFiles(in.selectedFilesList);
if(i==in.selectedFilesList.size() && in.returnedMessage.type==FileHandler.SUCCESS_MESSAGE){
	in.tmpBoolean=true;
}
else{ in.tmpBoolean=false;}

if(in.tmpBoolean){
	List<DocumentOnServer> docs = new List<DocumentOnServer>(); 
	for(java.io.File file: in.selectedFilesList){
		for(DocumentOnServer doc: in.documentsInDb){
			if(doc.filename.equals(file.getName())){
				docs.add(doc);
			}
		}
	}
	if(docs.size()>0){
		in.documentsInDb.removeAll(docs);
	}
}' #txt
Fs0 f113 type ch.ivyteam.ivy.addons.filemanager.FileListTable.FileListTableData #txt
Fs0 f113 1734 260 36 24 -57 -35 #rect
...
' #txt
Fs0 f114 1794 208 1760 260 #arcP
...
Fs0 f115 requestMappingAction 'param.icon="/ch/ivyteam/ivy/addons/icons/question/48";
...
out.tmpString=result.pressedButton;
' #txt
Fs0 f115 windowConfiguration '{/title "<%=in.windowTitle%>"/width 0 /height 0 /centered true /resizable true /maximized false /close_after_last_rd true }' #txt
Fs0 f115 isAsynch false #txt
Fs0 f115 isInnerRd true #txt
Fs0 f115 isDialog true #txt
Fs0 f115 1782 84 36 24 20 -2 #rect
Fs0 f115 @|RichDialogIcon #fIcon
Fs0 f116 expr out #txt
Fs0 f116 1800 66 1800 84 #arcP
...
' #txt
Fs0 f117 1786 130 28 28 14 0 #rect
Fs0 f117 @|AlternativeIcon #fIcon
Fs0 f118 expr out #txt
Fs0 f118 1800 108 1800 130 #arcP
...
' #txt
Fs0 f112 1800 158 1800 186 #arcP
...
if(panel.fileListTable.getSelectedListEntry() != null && panel.fileListTable.getSelectedListEntry() instanceof DocumentOnServer){
	...
	if(in.selectedDocumentOnServer.locked.compareTo("1")==0){
		...
		int i=0;
		try{
			i= in.fileManagementHandler.deleteDocuments(new List<ch.ivyteam.ivy.addons.filemanager.DocumentOnServer>().add(in.selectedDocumentOnServer));
		}catch(Throwable t){
			in.errorUtil.panelId = in.panelId;
			in.errorUtil.errorOccurred=true;
			in.errorUtil.throwable = t;
		...
		in.returnedMessage=FileHandler.deleteFile(in.selectedDocumentOnServer.path);
		if(i==1 && in.returnedMessage.type==FileHandler.SUCCESS_MESSAGE){
			in.tmpBoolean=true;
			in.documentsInDb.remove(in.selectedDocumentOnServer);
		}
		else{
			in.tmpBoolean=false;
		}
...
Fs0 f120 1838 260 36 24 -1 -35 #rect
...
' #txt
Fs0 f121 1806 208 1847 260 #arcP
...
Fs0 f125 1870 316 36 24 20 -2 #rect
...
' #txt
Fs0 f126 1822 328 1870 328 #arcP
...
Fs0 f128 1790 372 36 24 20 -2 #rect
...
' #txt
Fs0 f129 1808 342 1808 372 #arcP
...
Fs0 f56 78 676 36 24 20 -2 #rect
Fs0 f56 @|RichDialogProcessStepIcon #fIcon
Fs0 f132 expr out #txt
Fs0 f132 878 688 114 688 #arcP
...
Fs0 f34 78 788 36 24 20 -2 #rect
Fs0 f34 @|RichDialogProcessStepIcon #fIcon
Fs0 f8 expr out #txt
Fs0 f8 96 812 96 851 #arcP
Fs0 f134 expr out #txt
Fs0 f134 96 700 96 788 #arcP
...
' #txt
Fs0 f137 878 590 20 20 -17 -32 #rect
Fs0 f137 @|RichDialogMethodStartIcon #fIcon
Fs0 f138 expr out #txt
Fs0 f138 878 600 114 600 #arcP
...
' #txt
Fs0 f60 1230 542 20 20 -59 -31 #rect
...
Fs0 f141 1790 420 36 24 -89 -6 #rect
Fs0 f141 @|RichDialogFireEventIcon #fIcon
Fs0 f142 expr out #txt
Fs0 f142 1808 396 1808 420 #arcP
Fs0 f123 expr out #txt
Fs0 f123 1808 444 1808 467 #arcP
...
' #txt
Fs0 f152 1262 902 20 20 13 0 #rect
...
' #txt
Fs0 f153 1262 998 20 20 13 0 #rect
...
Fs0 f158 1222 572 36 24 20 -2 #rect
Fs0 f158 @|RichDialogProcessStepIcon #fIcon
Fs0 f159 expr out #txt
Fs0 f159 1240 562 1240 572 #arcP
Fs0 f69 expr out #txt
Fs0 f69 1240 596 1240 620 #arcP
...
Fs0 f167 1486 244 36 24 20 -2 #rect
Fs0 f167 @|RichDialogProcessStepIcon #fIcon
Fs0 f168 expr out #txt
Fs0 f168 1504 218 1504 244 #arcP
Fs0 f51 expr out #txt
Fs0 f51 1504 268 1504 283 #arcP
...
try{
	...
	if(in.selectedFile.isFile()){
		boolean locked =in.fileManagementHandler.lockFile(in.selectedFile,ivy.session.getSessionUserName());
		if(locked){
			panel.desktopHandlerPanel.openFileAndCheckForChanges(in.selectedFile);
			panel.refresh();
		}else{
			panel.desktopHandlerPanel.openFile(in.selectedFile);
		}
...
Fs0 f173 1614 108 36 24 20 -2 #rect
Fs0 f173 @|RichDialogProcessStepIcon #fIcon
Fs0 f174 expr out #txt
Fs0 f174 1632 74 1632 108 #arcP
Fs0 f48 expr out #txt
Fs0 f48 1632 132 1632 195 #arcP
...
' #txt
Fs0 f175 2110 38 20 20 13 0 #rect
...
Fs0 f176 2110 94 20 20 13 0 #rect
Fs0 f176 @|RichDialogProcessEndIcon #fIcon
Fs0 f177 expr out #txt
Fs0 f177 2120 58 2120 94 #arcP
...
Fs0 f178 1870 582 20 20 -28 -31 #rect
...
Fs0 f179 1870 678 20 20 13 0 #rect
...
' #txt
Fs0 f196 2110 166 20 20 13 0 #rect
...
' #txt
Fs0 f197 2106 218 28 28 14 0 #rect
Fs0 f197 @|AlternativeIcon #fIcon
Fs0 f198 expr out #txt
Fs0 f198 2120 186 2120 218 #arcP
...
' #txt
Fs0 f206 2120 246 2120 292 #arcP
...
' #txt
Fs0 f208 82 634 28 28 14 0 #rect
Fs0 f208 @|AlternativeIcon #fIcon
Fs0 f209 expr out #txt
Fs0 f209 96 612 96 634 #arcP
...
' #txt
Fs0 f210 82 648 83 864 #arcP
Fs0 f210 1 16 648 #addKink
Fs0 f210 2 16 864 #addKink
Fs0 f210 0 0.3787878787878788 0 -5 #arcLabel
Fs0 f58 expr in #txt
Fs0 f58 96 662 96 676 #arcP
Fs0 f211 expr in #txt
Fs0 f211 outCond in.errorUtil.errorOccurred #txt
Fs0 f211 .xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>YES</name>
        <nameStyle>3,7,9
...
' #txt
Fs0 f211 82 552 83 864 #arcP
Fs0 f211 1 16 552 #addKink
Fs0 f211 2 16 864 #addKink
Fs0 f211 0 0.36363636363636365 0 -5 #arcLabel
...
Fs0 f202 1862 628 36 24 20 -2 #rect
Fs0 f202 @|RichDialogProcessStepIcon #fIcon
Fs0 f207 expr out #txt
Fs0 f207 1880 602 1880 628 #arcP
Fs0 f180 expr out #txt
Fs0 f180 1880 652 1880 678 #arcP
...
Fs0 f33 mainOut f132 tail #connect
Fs0 f132 head f56 mainIn #connect
...
Fs0 f137 mainOut f138 tail #connect
Fs0 f138 head f57 mainIn #connect
...
Fs0 f60 mainOut f159 tail #connect
...
Fs0 f55 head f57 mainIn #connect
...
Fs0 f199 out f211 tail #connect
Fs0 f211 head f1 mainIn #connect
Fs0 f199 out f55 tail #connect
