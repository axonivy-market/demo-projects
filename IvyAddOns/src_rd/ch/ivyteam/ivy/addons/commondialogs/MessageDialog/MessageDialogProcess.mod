[Ivy]
[>Created: Tue Sep 23 09:02:11 CEST 2008]
1180E22A4CFB14EE 3.10 #module
...
Ms0 f4 371 123 26 26 14 0 #rect
Ms0 f4 @|RichDialogEndIcon #fIcon
Ms0 @PushWFArc f5 '' #zField
Ms0 f5 expr out #txt
Ms0 f5 384 50 384 123 #arcP
...
' #txt
Ms0 f2 actionCode 'import org.apache.commons.lang.StringEscapeUtils;

panel.messageTextHtmlPane.setText(StringEscapeUtils.escapeHtml(in.messageText).replace("\n","<br>"));

panel.messageTitleLabel.text = in.messageTitle;
panel.messageTitleLabel.visible = in.messageTitle.trim().length() > 0;' #txt
