[Ivy]
[>Created: Mon Feb 11 10:06:19 CET 2013]
...
{
	out.data.temp.msg = out.data.temp.msg + "<b>" + note.getCreationTimestamp() + " " + note.getWritterName() + ":" + "</b>" + "<br>" + note.getMessage() + "<br>";
}	' #txt
...
' #txt
Cs0 f8 78 276 36 24 20 -2 #rect
Cs0 f8 @|StepIcon #fIcon
Cs0 f9 expr out #txt
Cs0 f9 96 244 96 276 #arcP
Cs0 f14 expr out #txt
Cs0 f14 96 300 96 326 #arcP
Cs0 f24 expr in #txt
Cs0 f24 82 112 78 232 #arcP
Cs0 f24 1 48 112 #addKink
Cs0 f24 2 48 232 #addKink
Cs0 f24 1 0.7456685775790461 0 0 #arcLabel
...
Cs0 f7 mainOut f32 tail #connect
...
Cs0 f12 out f24 tail #connect
Cs0 f24 head f31 mainIn #connect
