[Ivy]
[>Created: Mon Feb 20 15:13:48 CET 2017]
...
' #txt
Ws0 f13 actionCode 'in.connectionInfo = com.axon.ivy.engine.config.ConnectionInfo.getConnectionInfo();' #txt
...
' #txt
Ws0 f13 168 42 112 44 -8 -8 #rect
Ws0 f13 @|StepIcon #fIcon
Ws0 f14 expr out #txt
Ws0 f14 109 64 168 64 #arcP
Ws0 f2 expr out #txt
...
Ws0 f0 mainOut f14 tail #connect
Ws0 f14 head f13 mainIn #connect
Ws0 f13 mainOut f2 tail #connect
