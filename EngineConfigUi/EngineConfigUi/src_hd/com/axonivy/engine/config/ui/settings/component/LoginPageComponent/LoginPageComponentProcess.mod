[Ivy]
[>Created: Tue Jun 06 15:28:09 CEST 2017]
15C7CA0FC7AF3A35 3.20 #module
...
Ls0 f0 type com.axonivy.engine.config.ui.settings.component.LoginPageComponent.LoginPageComponentData #txt
...
Ls0 f1 type com.axonivy.engine.config.ui.settings.component.LoginPageComponent.LoginPageComponentData #txt
Ls0 f1 211 51 26 26 0 12 #rect
Ls0 f1 @|RichDialogProcessEndIcon #fIcon
Ls0 f2 expr out #txt
Ls0 f2 109 64 211 64 #arcP
Ls0 f6 type com.axonivy.engine.config.ui.settings.component.LoginPageComponent.LoginPageComponentData #txt
Ls0 f6 340 112 26 26 0 12 #rect
Ls0 f6 @|RichDialogProcessEndIcon #fIcon
Ls0 f6 -1|-1|-9671572 #nodeStyle
Ls0 f7 actionDecl 'com.axonivy.engine.config.ui.settings.component.LoginPageComponent.LoginPageComponentData out;
' #txt
...
' #txt
Ls0 f7 type com.axonivy.engine.config.ui.settings.component.LoginPageComponent.LoginPageComponentData #txt
...
Ls0 f8 type com.axonivy.engine.config.ui.settings.component.LoginPageComponent.LoginPageComponentData #txt
Ls0 f8 actionDecl 'com.axonivy.engine.config.ui.settings.component.LoginPageComponent.LoginPageComponentData out;
' #txt
