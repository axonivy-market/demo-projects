[Ivy]
[>Created: Tue Sep 08 20:34:32 CEST 2015]
14FAE0B7D144AEDB 3.17 #module
...
As0 f6 actionDecl 'workflow.demo.AcceptProcurementRequest.AcceptProcurementRequestData out;
' #txt
As0 f6 actionTable 'out=in;
out.totalPrice=in.procurementRequestData.amount * in.procurementRequestData.pricePerUnit;
' #txt
As0 f6 type workflow.demo.AcceptProcurementRequest.AcceptProcurementRequestData #txt
...
' #txt
As0 f6 168 42 112 44 -37 -8 #rect
