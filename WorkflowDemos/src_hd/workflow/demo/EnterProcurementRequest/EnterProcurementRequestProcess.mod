[Ivy]
[>Created: Tue Sep 08 19:26:12 CEST 2015]
14FADF4C89B934FB 3.17 #module
...
Es0 f0 type workflow.demo.EnterProcurementRequest.EnterProcurementRequestData #txt
Es0 f0 method start() #txt
Es0 f0 disableUIEvents true #txt
Es0 f0 inParameterDecl 'ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent methodEvent = event as ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent;
<> param = methodEvent.getInputArguments();
' #txt
Es0 f0 outParameterDecl '<workflow.demo.ProcurementRequestData procurementRequestData> result;
' #txt
...
Es0 f1 type workflow.demo.EnterProcurementRequest.EnterProcurementRequestData #txt
Es0 f1 339 51 26 26 0 12 #rect
Es0 f1 @|RichDialogProcessEndIcon #fIcon
Es0 f3 guid 14FADF4C908E8C33 #txt
Es0 f3 type workflow.demo.EnterProcurementRequest.EnterProcurementRequestData #txt
Es0 f3 actionDecl 'workflow.demo.EnterProcurementRequest.EnterProcurementRequestData out;
' #txt
...
Es0 f4 type workflow.demo.EnterProcurementRequest.EnterProcurementRequestData #txt
Es0 f4 guid 14FADF4C908290E6 #txt
Es0 f4 211 147 26 26 0 12 #rect
Es0 f4 @|RichDialogEndIcon #fIcon
Es0 f5 expr out #txt
Es0 f5 109 160 211 160 #arcP
Es0 f6 actionDecl 'workflow.demo.EnterProcurementRequest.EnterProcurementRequestData out;
' #txt
...
>Proto Es0 .type workflow.demo.EnterProcurementRequest.EnterProcurementRequestData #txt
