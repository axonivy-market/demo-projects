...
Vs0 f0 type workflow.demo.MgrVerifyProcurementRequest.MgrVerifyProcurementRequestData #txt
...
Vs0 f1 type workflow.demo.MgrVerifyProcurementRequest.MgrVerifyProcurementRequestData #txt
Vs0 f1 339 51 26 26 0 12 #rect
Vs0 f1 @|RichDialogProcessEndIcon #fIcon
Vs0 f3 guid 14FAE0721B1EC7B7 #txt
Vs0 f3 type workflow.demo.MgrVerifyProcurementRequest.MgrVerifyProcurementRequestData #txt
Vs0 f3 actionDecl 'workflow.demo.MgrVerifyProcurementRequest.MgrVerifyProcurementRequestData out;
' #txt
...
Vs0 f4 type workflow.demo.MgrVerifyProcurementRequest.MgrVerifyProcurementRequestData #txt
...
>Proto Vs0 .type workflow.demo.MgrVerifyProcurementRequest.MgrVerifyProcurementRequestData #txt
