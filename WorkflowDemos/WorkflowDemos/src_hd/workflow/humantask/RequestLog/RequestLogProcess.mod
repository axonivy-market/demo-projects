...
Rs0 f0 type workflow.humantask.RequestLog.RequestLogData #txt
...
Rs0 f1 type workflow.humantask.RequestLog.RequestLogData #txt
...
Rs0 f3 type workflow.humantask.RequestLog.RequestLogData #txt
Rs0 f3 actionDecl 'workflow.humantask.RequestLog.RequestLogData out;
' #txt
...
Rs0 f4 type workflow.humantask.RequestLog.RequestLogData #txt
Rs0 f4 guid 152A20DB251DDF54 #txt
