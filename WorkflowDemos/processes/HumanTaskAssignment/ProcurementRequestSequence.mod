[Ivy]
[>Created: Tue Jan 26 11:23:27 CET 2016]
...
Pt0 f0 startName '<%=ivy.cms.co("/ProcessDescriptions/procurementRequest")%> (<%=ivy.cms.co("/ProcessDescriptions/sequenceTaskExample")%>)' #txt
