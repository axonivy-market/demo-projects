...
public class WebTestErrorHandling
{
  ...
  public void ajax_error_dialog()
  {
    ...
    assertThat(text)
        ...
        .contains("/ivy/faces/instances/"+EngineUrl.applicationName()+"/html-dialog-demos$1/").contains("/ch.ivyteam.htmldialog.demo.other.ErrorHandling/ErrorHandling.xhtml")
        .contains("Servlet")
