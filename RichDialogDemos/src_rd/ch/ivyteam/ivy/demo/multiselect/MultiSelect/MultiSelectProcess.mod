[Ivy]
[>Created: Mon May 25 12:57:42 CEST 2009]
11A2431620A5E9B5 3.11 #module
...
' #txt
Ms0 f0 embeddedRdInitializations '{/titlePanel {/fieldName "titlePanel"/startMethod "startInitialized(String,String,String)"/parameterMapping "param.iconUri=\"/ch/ivyteam/ivy/demo/icons/large/multi_select\";\nparam.title=\"Multi-Selection Demo\";\nparam.subtitle=\"Shows how to work with multi-selection in lists and tables.\";\n"/initScript ""}/innerListPanel {/fieldName "innerListPanel"/startMethod "start()"/parameterMapping ""/initScript ""}}' #txt
